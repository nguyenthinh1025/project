...
//     var t = e.length,
//       r = n.type(e);
//     return "function" === r || n.isWindow(e)
//       ? !1
//       : 1 === e.nodeType && t
//       ? !0
//       : "array" === r ||
...
//       if (
//         ((i = "data-" + t.replace(O, "-$1").toLowerCase()),
//         (r = e.getAttribute(i)),
//         "string" == typeof r)
//       ) {
//         try {
...
//       n.nodeName(11 !== t.nodeType ? t : t.firstChild, "tr")
...
//       if (
//         L.hasData(e) &&
//         ((o = L.access(e)), (u = L.set(t, o)), (l = o.events))
//       ) {
...
//   function sb(e, t) {
//     var r,
//       i = n(t.createElement(e)).appendTo(t.body),
//       s =
//         a.getDefaultComputedStyle && (r = a.getDefaultComputedStyle(i[0]))
//           ? r.display
//           : n.css(i[0], "display");
//     return i.detach(), s;
//   }
...
//       r &&
//         ("" !== u || n.contains(e.ownerDocument, e) || (u = n.style(e, t)),
//         vb.test(u) &&
//           ub.test(t) &&
//           ((i = a.width),
//           (s = a.minWidth),
...
//     for (
//       var o = r === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0,
//         u = 0;
//       4 > o;
//       o += 2
//     )
...
//         i
//           ? ("content" === r && (u -= n.css(e, "padding" + R[o], !0, s)),
//             "margin" !== r && (u -= n.css(e, "border" + R[o] + "Width", !0, s)))
//           : ((u += n.css(e, "padding" + R[o], !0, s)),
//             "padding" !== r &&
//               (u += n.css(e, "border" + R[o] + "Width", !0, s)));
//     return u;
//   }
//   function Ib(e, t, r) {
//     var i = !0,
...
//       (i = e[u]),
//         i.style &&
//           ((o[u] = L.get(i, "olddisplay")),
//           (r = i.style.display),
//           t
//             ? (o[u] || "none" !== r || (i.style.display = ""),
//               "" === i.style.display &&
//                 S(i) &&
//                 (o[u] = L.access(i, "olddisplay", tb(i.nodeName))))
//             : ((s = S(i)),
//               ("none" === r && s) ||
//                 L.set(i, "olddisplay", s ? r : n.css(i, "display"))));
//     for (u = 0; a > u; u++)
//       (i = e[u]),
//         i.style &&
//           ((t && "none" !== i.style.display && "" !== i.style.display) ||
//             (i.style.display = t ? o[u] || "" : "none"));
//     return e;
//   }
...
//       (n = R[r]), (i["margin" + n] = i["padding" + n] = e);
//     return t && (i.opacity = i.width = e), i;
//   }
//   function Ub(e, t, n) {
//     for (
//       var r, i = (Rb[t] || []).concat(Rb["*"]), s = 0, o = i.length;
//       o > s;
//       s++
//     )
...
//       if (((s = t[i]), Nb.exec(s))) {
//         if (
//           (delete t[i], (o = o || "toggle" === s), s === (v ? "hide" : "show"))
//         ) {
...
//         (s = t[i]),
//         (o = e[r]),
//         n.isArray(o) && ((s = o[1]), (o = e[r] = o[0])),
//         r !== i && ((e[i] = o), delete e[r]),
//         (u = n.cssHooks[i]),
//         u && "expand" in u)
//       ) {
...
//       n.fx.timer(n.extend(f, { elem: e, anim: l, queue: l.opts.queue })),
//       l
...
//           var a = n(t, r, i);
//           return "string" != typeof a || o || s[a]
//             ? o
//               ? !(h = a)
//               : void 0
//             : (t.dataTypes.unshift(a), u(a), !1);
//         }),
//         h
//       );
//     }
...
//         r || xc.test(e)
//           ? i(e, n)
//           : Bc(e + "[" + ("object" == typeof n ? t : "") + "]", n, r, i);
//       });
//     else if (r || "object" !== n.type(t)) i(e, t);
//     else for (s in t) Bc(e + "[" + s + "]", t[s], r, i);
//   }
//   function Kc(e) {
...
//           l = !1;
//         for (
//           "boolean" == typeof u && ((l = u), (u = arguments[a] || {}), a++),
...
//                 (i = e[t]),
//                 u !== i &&
//                   (l && i && (n.isPlainObject(i) || (s = n.isArray(i)))
//                     ? (s
//                         ? ((s = !1), (o = r && n.isArray(r) ? r : []))
//                         : (o = r && n.isPlainObject(r) ? r : {}),
//                       (u[t] = n.extend(l, o, i)))
//                     : void 0 !== i && (u[t] = i));
//         return u;
//       }),
...
//         return "object" !== n.type(e) || e.nodeType || n.isWindow(e)
//           ? !1
//           : e.constructor && !j.call(e.constructor.prototype, "isPrototypeOf")
//           ? !1
//           : !0;
//       },
...
//           a = s(t),
//           f = [];
//         if (a) for (; u > o; o++) (i = n(t[o], o, r)), null != i && f.push(i);
//         else for (o in t) (i = n(t[o], o, r)), null != i && f.push(i);
//         return e.apply([], f);
//       },
//       guid: 1,
//       proxy: function (e, t) {
...
//               (i = X.exec(u)) &&
//                 ((n = i.shift()),
//                 s.push({ value: n, type: i[0].replace(z, " ") }),
//                 (u = u.slice(n.length)));
//             for (o in r.filter)
//               !(i = K[o].exec(u)) ||
//                 (f[o] && !(i = f[o](i))) ||
...
//                 ))
//               ) {
//                 if ((f.splice(a, 1), (e = s.length && mt(f)), !e))
...
//         return (
//           (i = this.pushStack(r > 1 ? n.unique(i) : i)),
...
//       },
//       is: function (e) {
//         return !!x(this, "string" == typeof e && u.test(e) ? n(e) : e || [], !1)
//           .length;
//       },
//     });
//   var y,
...
//             n.merge(
//               this,
//               n.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : l, !0)
//             ),
...
//             s = this.length,
//             o = [],
//             a = u.test(e) || "string" != typeof e ? n(e, t || this.context) : 0;
//           s > i;
//           i++
//         )
...
//               (a
//                 ? a.index(r) > -1
//                 : 1 === r.nodeType && n.find.matchesSelector(r, e))
//             ) {
//               o.push(r);
//               break;
//             }
...
//       l = function (n) {
//         for (
//           t = e.memory && n, r = !0, u = s || 0, s = 0, o = a.length, i = !0;
//           a && o > u;
//           u++
//         )
...
//           ? ((i = this.get(e, t)),
//             void 0 !== i ? i : this.get(e, n.camelCase(t)))
...
//         else {
//           n.isArray(t)
//             ? (i = t.concat(t.map(n.camelCase)))
//             : ((s = n.camelCase(t)),
//               t in u
//                 ? (i = [t, s])
//                 : ((i = s), (i = i in u ? [i] : i.match(E) || []))),
//             (r = i.length);
...
//           if (
//             this.length &&
//             ((s = M.get(o)), 1 === o.nodeType && !L.get(o, "hasDataAttrs"))
//           ) {
//             r = u.length;
//             while (r--)
//               u[r] &&
//                 ((i = u[r].name),
//                 0 === i.indexOf("data-") &&
//                   ((i = n.camelCase(i.slice(5))), P(o, i, s[i])));
...
//             (u = g.handle =
//               function (t) {
//                 return typeof n !== U && n.event.triggered !== t.type
...
//                   (e.addEventListener && e.addEventListener(d, u, !1))),
//               h.add &&
...
//             u &&
//               !p.length &&
//               ((h.teardown && h.teardown.call(e, v, g.handle) !== !1) ||
//                 n.removeEvent(e, d, g.handle),
//               delete f[d]);
...
//           for (
//             f = p.delegateType || v, X.test(f + v) || (o = o.parentNode);
//             o;
//             o = o.parentNode
//           )
//             d.push(o), (u = o);
//           u === (r.ownerDocument || l) &&
//             d.push(u.defaultView || u.parentWindow || a);
//         }
//         s = 0;
...
//       u ||
//         (this.fixHooks[s] = u =
//           W.test(s) ? this.mouseHooks : V.test(s) ? this.keyHooks : {}),
...
//             i
//               ? L.access(n, t, i)
//               : (n.removeEventListener(e, r, !0), L.remove(n, t));
//           },
//         };
//       }),
//     n.fn.extend({
...
//           )
//         )
//           for (u = ob(a), o = ob(e), i = 0, s = o.length; s > i; i++)
//             pb(o[i], u[i]);
//         if (t)
//           if (r)
//             for (
//               o = o || ob(e), u = u || ob(a), i = 0, s = o.length;
//               s > i;
//               i++
//             )
//               nb(o[i], u[i]);
//           else nb(e, a);
//         return (
//           (u = ob(a, "script")), u.length > 0 && mb(u, !f && ob(e, "script")), a
//         );
//       },
...
//           if (
//             (!i || -1 === n.inArray(s, i)) &&
//             ((f = n.contains(s.ownerDocument, s)),
...
//         for (
//           var t, r, i, s, o = n.event.special, u = 0;
//           void 0 !== (r = e[u]);
//           u++
//         ) {
...
//       remove: function (e, t) {
//         for (
//           var r, i = e ? n.filter(e, this) : this, s = 0;
//           null != (r = i[s]);
//           s++
//         )
//           t || 1 !== r.nodeType || n.cleanData(ob(r)),
//             r.parentNode &&
//               (t && n.contains(r.ownerDocument, r) && mb(ob(r, "script")),
//               r.parentNode.removeChild(r));
//         return this;
//       },
//       empty: function () {
//         for (var e, t = 0; null != (e = this[t]); t++)
//           1 === e.nodeType && (n.cleanData(ob(e, !1)), (e.textContent = ""));
//         return this;
//       },
//       clone: function (e, t) {
//         return (
...
//                   (t = this[r] || {}),
//                     1 === t.nodeType &&
//                       (n.cleanData(ob(t, !1)), (t.innerHTML = e));
//                 t = 0;
//               } catch (s) {}
//             }
...
//         if (
//           c &&
//           ((i = n.buildFragment(t, this[0].ownerDocument, !1, this)),
//           (s = i.firstChild),
//           1 === i.childNodes.length && (i = s),
//           s)
//         ) {
//           for (o = n.map(ob(i, "script"), kb), u = o.length; c > l; l++)
//             (a = i),
//               l !== p &&
//                 ((a = n.clone(a, !0, !0)), u && n.merge(o, ob(a, "script"))),
//               r.call(this[l], a, l);
//           if (u)
//             for (
//               f = o[o.length - 1].ownerDocument, n.map(o, lb), l = 0;
//               u > l;
//               l++
//             )
//               (a = o[l]),
...
//                   n.contains(f, a) &&
//                   (a.src
//                     ? n._evalUrl && n._evalUrl(a.src)
//                     : n.globalEval(a.textContent.replace(hb, "")));
//         }
//         return this;
//       },
//     }),
...
//             var e,
//               t = s.appendChild(l.createElement("div"));
//             return (
...
//           f = e.style;
//         return (
//           (t = n.cssProps[a] || (n.cssProps[a] = Fb(f, a))),
//           (u = n.cssHooks[t] || n.cssHooks[a]),
//           void 0 === r
//             ? u && "get" in u && void 0 !== (s = u.get(e, !1, i))
//               ? s
//               : f[t]
//             : ((o = typeof r),
//               "string" === o &&
//                 (s = Bb.exec(r)) &&
//                 ((r = (s[1] + 1) * s[2] + parseFloat(n.css(e, t))),
//                 (o = "number")),
//               null != r &&
//                 r === r &&
//                 ("number" !== o || n.cssNumber[a] || (r += "px"),
//                 k.clearCloneStyle ||
//                   "" !== r ||
//                   0 !== t.indexOf("background") ||
//                   (f[t] = "inherit"),
//                 (u && "set" in u && void 0 === (r = u.set(e, r, i))) ||
//                   (f[t] = r)),
//               void 0)
//         );
//       }
...
//         a = n.camelCase(t);
//       return (
//         (t = n.cssProps[a] || (n.cssProps[a] = Fb(e.style, a))),
//         (u = n.cssHooks[t] || n.cssHooks[a]),
//         u && "get" in u && (s = u.get(e, !0, r)),
//         void 0 === s && (s = xb(e, t, i)),
//         "normal" === s && t in Db && (s = Db[t]),
//         "" === r || r
//           ? ((o = parseFloat(s)), r === !0 || n.isNumeric(o) ? o || 0 : s)
//           : s
//       );
//     },
//   }),
...
//         get: function (e, r, i) {
//           return r
//             ? zb.test(n.css(e, "display")) && 0 === e.offsetWidth
//               ? n.swap(e, Cb, function () {
//                   return Ib(e, t, i);
//                 })
//               : Ib(e, t, i)
//             : void 0;
...
//             r,
//             i
//               ? Hb(e, t, i, "border-box" === n.css(e, "boxSizing", !1, s), s)
//               : 0
//           );
//         },
//       };
...
//       return t
//         ? n.swap(e, { display: "inline-block" }, xb, [e, "marginRight"])
//         : void 0;
//     })),
...
//             ? ((t = n.css(e.elem, e.prop, "")), t && "auto" !== t ? t : 0)
//             : e.elem[e.prop];
//         },
//         set: function (e) {
//           n.fx.step[e.prop]
//             ? n.fx.step[e.prop](e)
//             : e.elem.style &&
//               (null != e.elem.style[n.cssProps[e.prop]] || n.cssHooks[e.prop])
...
//             u =
//               (n.cssNumber[e] || ("px" !== o && +i)) &&
//               Ob.exec(n.css(r.elem, e)),
//             a = 1,
//             f = 20;
//           if (u && u[3] !== o) {
//             (o = o || u[3]), (s = s || []), (u = +i || 1);
//             do (a = a || ".5"), (u /= a), n.style(r.elem, e, u + o);
...
//         (r = e[i]), (Rb[r] = Rb[r] || []), Rb[r].unshift(t);
//     },
...
//             else for (s in u) u[s] && u[s].stop && Pb.test(s) && i(u[s]);
//             for (s = o.length; s--; )
//               o[s].elem !== this ||
//                 (null != e && o[s].queue !== e) ||
//                 (o[s].anim.stop(r), (t = !1), o.splice(s, 1));
...
//                   ? s
//                   : ((s = n.find.attr(e, t)), null == s ? void 0 : s)
//                 : null !== r
//                 ? i && "set" in i && void 0 !== (s = i.set(e, r, t))
//                   ? s
...
//             void 0 !== r
//               ? s && "set" in s && void 0 !== (i = s.set(e, r, t))
//                 ? i
//                 : (e[t] = r)
...
//         tabIndex: {
//           get: function (e) {
//             return e.hasAttribute("tabindex") || _b.test(e.nodeName) || e.href
//               ? e.tabIndex
//               : -1;
//           },
//         },
...
//             (i =
//               1 === r.nodeType &&
//               (r.className ? (" " + r.className + " ").replace(ac, " ") : " ")))
//           ) {
//             o = 0;
...
//         if (
//           1 === this[n].nodeType &&
//           (" " + this[n].className + " ").replace(ac, " ").indexOf(t) >= 0
//         )
//           return !0;
//       return !1;
//     },
...
//             var s;
//             1 === this.nodeType &&
//               ((s = i ? e.call(this, r, n(this).val()) : e),
//               null == s
//                 ? (s = "")
//                 : "number" == typeof s
//                 ? (s += "")
//                 : n.isArray(s) &&
//                   (s = n.map(s, function (e) {
//                     return null == e ? "" : e + "";
//                   })),
//               (t =
...
//       if (s)
//         return (
//           (t = n.valHooks[s.type] || n.valHooks[s.nodeName.toLowerCase()]),
//           t && "get" in t && void 0 !== (r = t.get(s, "value"))
//             ? r
//             : ((r = s.value),
...
//                     n.nodeName(r.parentNode, "optgroup"))
//                 ))
//               ) {
...
//               u = s.length;
//             while (u--)
//               (i = s[u]), (i.selected = n.inArray(i.value, o) >= 0) && (r = !0);
...
//         set: function (e, t) {
//           return n.isArray(t)
//             ? (e.checked = n.inArray(n(e).val(), t) >= 0)
//             : void 0;
//         },
//       }),
//         k.checkOn ||
...
//                   : 304 === e
//                   ? (x = "notmodified")
//                   : ((x = w.state), (g = w.data), (y = w.error), (l = !y)))
...
//             (c.data = n.param(c.data, c.traditional)),
//           sc(nc, c, t, S),
//           2 === b)
//         )
//           return S;
...
//           c.hasContent ||
//             (c.data &&
//               ((i = c.url += (dc.test(i) ? "&" : "?") + c.data), delete c.data),
//             c.cache === !1 &&
//               (c.url = hc.test(i)
//                 ? i.replace(hc, "$1_=" + cc++)
//                 : i + (dc.test(i) ? "&" : "?") + "_=" + cc++)),
...
//         return (
//           n.isFunction(r) && ((s = s || i), (i = r), (r = void 0)),
//           n.ajax({ url: e, type: t, dataType: s, data: r, success: i })
//         );
//       };
//     }),
//     n.each(
...
//       };
//     if (
//       (void 0 === t && (t = n.ajaxSettings && n.ajaxSettings.traditional),
...
//               : e.jsonpCallback),
//           u
//             ? (e[u] = e[u].replace(Hc, "$1" + i))
//             : e.jsonp !== !1 &&
//               (e.url += (dc.test(e.url) ? "&" : "?") + e.jsonp + "=" + i),
...
//           r.always(function () {
//             (a[i] = s),
//               e[i] && ((e.jsonpCallback = t.jsonpCallback), Gc.push(i)),
...
//       a = e.indexOf(" ");
//     return (
//       a >= 0 && ((i = n.trim(e.slice(a))), (e = e.slice(0, a))),
//       n.isFunction(t)
//         ? ((r = t), (t = void 0))
...
//         (f = n.css(e, "left")),
//         (l =
//           ("absolute" === c || "fixed" === c) && (o + f).indexOf("auto") > -1),
//         l
//           ? ((i = h.position()), (u = i.top), (s = i.left))
//           : ((u = parseFloat(o) || 0), (s = parseFloat(f) || 0)),
...
//                   : e[n]
//                 : void (s
//                     ? s.scrollTo(r ? a.pageXOffset : i, r ? i : a.pageYOffset)
//                     : (e[n] = i));
//             },
//             e,
//             n,
...
//         return r
//           ? ((r = xb(e, t)), vb.test(r) ? n(e).position()[t] + "px" : r)
//           : void 0;
//       });
//     }),
...
//             u = t(e);
//           if (r) {
//             if (u) for (; o > s && ((i = n.apply(e[s], r)), i !== !1); s++);
//             else for (s in e) if (((i = n.apply(e[s], r)), i === !1)) break;
//           } else if (u)
//             for (; o > s && ((i = n.call(e[s], s, e[s])), i !== !1); s++);
...
//           for (
//             "boolean" == typeof u && ((l = u), (u = arguments[a] || {}), a++),
//               "object" != typeof u && "function" !== n.type(u) && (u = {}),
//               a === f && ((u = this), a--);
//             f > a;
//             a++
//           )
...
//                   (r = s[i]),
//                   u !== r &&
//                     (l && r && (n.isPlainObject(r) || (t = n.isArray(r)))
//                       ? (t
//                           ? ((t = !1), (o = e && n.isArray(e) ? e : []))
...
//             var o = n.data(e, r);
//             return i
//               ? (!o || n.isArray(i) ? (o = n.data(e, r, s(i))) : o.push(i), o)
//               : o || [];
//           }
//         }),
...
//                 e.style &&
//                   ((i.top += parseFloat(e.style.borderTopWidth) || 0),
...
//       function s(e) {
//         return (
//           d.isWrapped(e) ? (e = [].slice.call(e)) : d.isNode(e) && (e = [e]), e
//         );
//       }
//       function o(e) {
...
//         }
//         function a(e, t, n) {
//           return ((s(t, n) * e + o(t, n)) * e + u(t)) * e;
//         }
//         function f(e, t, n) {
//           return 3 * s(t, n) * e * e + 2 * o(t, n) * e + u(t);
//         }
//         function l(t, n) {
//           for (var i = 0; v > i; ++i) {
//             var s = f(n, e, r);
...
//         }
//         function c() {
//           for (var t = 0; b > t; ++t) x[t] = a(t * w, e, r);
//         }
//         function h(t, n, i) {
//           var s,
//             o,
...
//               (s = a(o, e, r) - t),
//               s > 0 ? (i = o) : (n = o);
//           while (Math.abs(s) > g && ++u < y);
//           return o;
//         }
//         function p(t) {
//           for (var n = 0, i = 1, s = b - 1; i != s && x[i] <= t; ++i) n += w;
//           --i;
//           var o = (t - x[i]) / (x[i + 1] - x[i]),
//             u = n + o * w,
//             a = f(u, e, r);
//           return a >= m ? l(t, u) : 0 == a ? u : h(t, n, n + w);
//         }
//         function d() {
//           (T = !0), (e != n || r != i) && c();
//         }
...
//           (e = Math.max(e, 0)),
//           (r = Math.max(r, 0));
//         var x = E ? new Float32Array(b) : new Array(b),
//           T = !1,
//           N = function (t) {
//             return (
//               T || d(),
//               e === n && r === i ? t : 0 === t ? 0 : 1 === t ? 1 : a(p(t), n, i)
//             );
//           };
...
//         if (e)
//           for (
//             var t = new Date().getTime(), n = 0, i = b.State.calls.length;
//             i > n;
//             n++
//           )
//             if (b.State.calls[n]) {
//               var s = b.State.calls[n],
//                 u = s[0],
//                 a = s[2],
//                 f = s[3];
//               f || (f = b.State.calls[n][3] = t - 16);
//               for (
//                 var h = Math.min((t - f) / a.duration, 1), p = 0, m = u.length;
//                 m > p;
//                 p++
//               ) {
//                 var g = u[p],
...
//                         E.setPropertyValue(y, "display", t);
//                       });
//                     }
//                     E.setPropertyValue(y, "display", a.display);
//                   }
//                   a.visibility &&
//                     "hidden" !== a.visibility &&
//                     E.setPropertyValue(y, "visibility", a.visibility);
//                   for (var T in g)
//                     if ("element" !== T) {
//                       var N = g[T],
//                         C,
//                         k = d.isString(N.easing)
//                           ? b.Easings[N.easing]
//                           : N.easing;
//                       if (
//                         ((C =
...
//                             ? N.endValue
//                             : N.startValue +
//                               (N.endValue - N.startValue) * k(h)),
//                         (N.currentValue = C),
//                         E.Hooks.registered[T])
//                       ) {
//                         var L = E.Hooks.getRoot(T),
//                           A = o(y).rootPropertyValueCache[L];
//                         A && (N.rootPropertyValue = A);
//                       }
//                       var O = E.setPropertyValue(
//                         y,
//                         T,
//                         N.currentValue +
//                           (0 === parseFloat(C) ? "" : N.unitType),
//                         N.rootPropertyValue,
//                         N.scrollData
//                       );
//                       E.Hooks.registered[T] &&
//                         (o(y).rootPropertyValueCache[L] = E.Normalizations
//                           .registered[L]
//                           ? E.Normalizations.registered[L](
//                               "extract",
//                               null,
//                               O[1]
//                             )
...
//                     }
//                   a.mobileHA &&
//                     o(y).transformCache.translate3d === r &&
//                     ((o(y).transformCache.translate3d = "(0px, 0px, 0px)"),
//                     (w = !0)),
//                     w && E.flushTransformCache(y);
//                 }
//               }
//               a.display !== r &&
//                 "none" !== a.display &&
//                 (b.State.calls[n][2].display = !1),
//                 a.visibility &&
//                   "hidden" !== a.visibility &&
//                   (b.State.calls[n][2].visibility = !1),
//                 a.progress &&
//                   a.progress.call(
//                     s[1],
//                     s[1],
//                     h,
//                     Math.max(0, f + a.duration - t),
//                     f
//                   ),
//                 1 === h && c(n);
//             }
...
//               "hidden" === s.visibility &&
//                 E.setPropertyValue(c, "visibility", s.visibility)),
//             (v.queue(c)[1] === r ||
//               !/\.velocityQueueEntryFlag/i.test(v.queue(c)[1])) &&
//               o(c))
//           ) {
//             (o(c).isAnimating = !1), (o(c).rootPropertyValueCache = {});
//             var h = !1;
//             v.each(E.Lists.transforms3D, function (e, t) {
//               var n = /^scale/.test(t) ? 1 : 0,
//                 i = o(c).transformCache[t];
//               o(c).transformCache[t] !== r &&
//                 new RegExp("^\\(" + n + "[^.]").test(i) &&
//                 ((h = !0), delete o(c).transformCache[t]);
//             }),
//               s.mobileHA && ((h = !0), delete o(c).transformCache.translate3d),
//               h && E.flushTransformCache(c),
//               E.Values.removeClass(c, "velocity-animating");
//           }
//           if (!t && s.complete && !s.loop && f === l - 1)
//             try {
//               s.complete.call(i, i);
//             } catch (p) {
//               setTimeout(function () {
...
//             s.loop !== !0 ||
//               t ||
//               (v.each(o(c).tweensContainer, function (e, t) {
//                 /^rotate/.test(e) &&
//                   360 === parseFloat(t.endValue) &&
//                   ((t.endValue = 0), (t.startValue = 360));
//               }),
//               b(c, "reverse", { loop: !0, delay: s.delay })),
//             s.queue !== !1 && v.dequeue(c, s.queue);
//         }
//         b.State.calls[e] = !1;
//         for (var d = 0, m = b.State.calls.length; m > d; d++)
//           if (b.State.calls[d] !== !1) {
//             a = !0;
//             break;
//           }
//         a === !1 &&
...
//         m = !1;
//       if (
//         (e.fn && e.fn.jquery ? ((v = e), (m = !0)) : (v = t.Velocity.Utilities),
//         8 >= h && !m)
//       )
//         throw new Error(
...
//           ],
//           function (e, t) {
//             b.Easings[t[0]] = a.apply(null, t[1]);
//           }
//         );
//       var E = (b.CSS = {
//         RegEx: {
...
//                 (n = E.Hooks.templates[t]), (r = n[0].split(" "));
//                 var i = n[1].match(E.RegEx.valueSplit);
//                 "Color" === r[0] &&
//                   (r.push(r.shift()),
//                   i.push(i.shift()),
//                   (E.Hooks.templates[t] = [r.join(" "), i.join(" ")]));
//               }
//             for (t in E.Hooks.templates) {
//               (n = E.Hooks.templates[t]), (r = n[0].split(" "));
//               for (var e in r) {
...
//                 (t = t.match(E.Hooks.RegEx.valueUnwrap)[1]),
...
//                 i = n[1];
//               return (
//                 (t = E.Hooks.cleanRootPropertyValue(r, t)),
//                 t.toString().match(E.RegEx.valueSplit)[i]
//               );
//             }
//             return t;
//           },
...
//                 u;
//               return (
//                 (n = E.Hooks.cleanRootPropertyValue(i, n)),
//                 (o = n.toString().match(E.RegEx.valueSplit)),
//                 (o[s] = t),
//                 (u = o.join(" "))
//               );
//             }
...
//                   var r;
//                   return (
//                     E.RegEx.wrappedValueAlreadyExtracted.test(n)
//                       ? (r = n)
//                       : ((r = n.toString().match(E.RegEx.valueUnwrap)),
...
//               ));
//             for (var e = 0; e < E.Lists.transformsBase.length; e++)
//               !(function () {
//                 var t = E.Lists.transformsBase[e];
//                 E.Normalizations.registered[t] = function (e, n, i) {
//                   switch (e) {
//                     case "name":
//                       return "transform";
//                     case "extract":
//                       return o(n) === r || o(n).transformCache[t] === r
//                         ? /^scale/i.test(t)
//                           ? 1
//                           : 0
...
//                     case "extract":
//                       var s;
//                       if (E.RegEx.wrappedValueAlreadyExtracted.test(i)) s = i;
//                       else {
//                         var o,
//                           u = {
//                             black: "rgb(0, 0, 0)",
...
//                         /^[A-z]+$/i.test(i)
//                           ? (o = u[i] !== r ? u[i] : u.black)
//                           : E.RegEx.isHex.test(i)
//                           ? (o = "rgb(" + E.Values.hexToRgb(i).join(" ") + ")")
//                           : /^rgba?\(/i.test(i) || (o = u.black),
//                           (s = (o || i)
//                             .toString()
...
//                       })),
//                 d.isString(b.State.prefixElement.style[i]))
//               )
//                 return (b.State.prefixMatches[e] = i), [i, !0];
//             }
//             return [e, !1];
//           },
//         },
...
//           function u(e, n) {
//             function i() {
//               f && E.setPropertyValue(e, "display", "none");
//             }
//             var a = 0;
//             if (8 >= h) a = v.css(e, n);
//             else {
...
//                   ((f = !0),
//                   E.setPropertyValue(e, "display", E.Values.getDisplayType(e))),
//                 !s)
//               ) {
//                 if (
//                   "height" === n &&
//                   "border-box" !==
//                     E.getPropertyValue(e, "boxSizing").toString().toLowerCase()
//                 ) {
//                   var l =
//                     e.offsetHeight -
//                     (parseFloat(E.getPropertyValue(e, "borderTopWidth")) || 0) -
//                     (parseFloat(E.getPropertyValue(e, "borderBottomWidth")) ||
//                       0) -
...
//                       0) -
//                     (parseFloat(E.getPropertyValue(e, "borderRightWidth")) ||
//                       0) -
...
//                   "borderColor" === n &&
//                   (n = "borderTopColor"),
//                 (a = 9 === h && "filter" === n ? p.getPropertyValue(n) : p[n]),
//                 ("" === a || null === a) && (a = e.style[n]),
//                 i();
//             }
//             if ("auto" === a && /^(top|right|bottom|left)$/i.test(n)) {
//               var d = u(e, "position");
//               ("fixed" === d || ("absolute" === d && /top|left/i.test(n))) &&
//                 (a = v(e).position()[n] + "px");
//             }
//             return a;
//           }
...
//             var f = n,
//               l = E.Hooks.getRoot(f);
//             i === r && (i = E.getPropertyValue(e, E.Names.prefixCheck(l)[0])),
//               E.Normalizations.registered[l] &&
//                 (i = E.Normalizations.registered[l]("extract", e, i)),
//               (a = E.Hooks.extractValue(f, i));
//           } else if (E.Normalizations.registered[n]) {
//             var c, p;
//             (c = E.Normalizations.registered[n]("name", e)),
//               "transform" !== c &&
//                 ((p = u(e, E.Names.prefixCheck(c)[0])),
//                 E.Values.isCSSNullValue(p) &&
//                   E.Hooks.templates[n] &&
//                   (p = E.Hooks.templates[n][1])),
//               (a = E.Normalizations.registered[n]("extract", e, p));
//           }
//           return (
//             /^[\d-]/.test(a) ||
//               (a =
//                 o(e) && o(e).isSVG && E.Names.SVGAttribute(n)
//                   ? /^(height|width)$/i.test(n)
//                     ? e.getBBox()[n]
//                     : e.getAttribute(n)
//                   : u(e, E.Names.prefixCheck(n)[0])),
//             E.Values.isCSSNullValue(a) && (a = 0),
//             b.debug >= 2 && console.log("Get " + n + ": " + a),
//             a
//           );
//         },
...
//             "transform" === E.Normalizations.registered[n]("name", e)
//           )
//             E.Normalizations.registered[n]("inject", e, r),
//               (u = "transform"),
...
//               var a = n,
//                 f = E.Hooks.getRoot(n);
//               (i = i || E.getPropertyValue(e, f)),
//                 (r = E.Hooks.injectValue(a, r, i)),
//                 (n = f);
//             }
//             if (
//               (E.Normalizations.registered[n] &&
//                 ((r = E.Normalizations.registered[n]("inject", e, r)),
//                 (n = E.Normalizations.registered[n]("name", e))),
//               (u = E.Names.prefixCheck(n)[0]),
//               8 >= h)
//             )
//               try {
//                 e.style[u] = r;
...
//                 b.debug &&
//                   console.log(
//                     "Browser does not support [" + r + "] for [" + u + "]"
//                   );
//               }
//             else
//               o(e) && o(e).isSVG && E.Names.SVGAttribute(n)
//                 ? e.setAttribute(n, r)
//                 : (e.style[u] = r);
//             b.debug >= 2 && console.log("Set " + n + " (" + u + "): " + r);
//           }
//           return [u, r];
//         },
...
//           } else {
//             var i, s;
//             v.each(o(e).transformCache, function (t) {
//               return (
//                 (i = o(e).transformCache[t]),
...
//               s && (n = "perspective" + s + " " + n);
//           }
//           E.setPropertyValue(e, "transform", n);
//         },
//       });
//       E.Hooks.register(),
...
//               if ((o(s) === r && b.init(s), n === r))
//                 i === r && (i = b.CSS.getPropertyValue(s, t));
//               else {
//                 var u = b.CSS.setPropertyValue(s, t, n);
//                 "transform" === u[0] && b.CSS.flushTransformCache(s), (i = u);
//               }
//             }),
//             i
//           );
...
//                     d.isFunction(e[1]) ||
//                     E.RegEx.isHex.test(e[1])
//                       ? (o = e[1])
//                       : ((d.isString(e[1]) && !E.RegEx.isHex.test(e[1])) ||
//                           d.isArray(e[1])) &&
//                         ((i = t ? e[1] : f(e[1], u.duration)),
//                         e[2] !== r && (o = e[2])))
//                   : (n = e),
//                 t || (i = i || u.easing),
//                 d.isFunction(n) && (n = n.call(s, N, T)),
//                 d.isFunction(o) && (o = o.call(s, N, T)),
//                 [n || 0, i, o]
//               );
//             }
//             function p(e, t) {
...
//                   position: E.getPropertyValue(s, "position"),
//                   fontSize: E.getPropertyValue(s, "fontSize"),
//                 },
//                 r =
//                   e.position === H.lastPosition && e.myParent === H.lastParent,
//                 i = e.fontSize === H.lastFontSize;
//               (H.lastParent = e.myParent),
//                 (H.lastPosition = e.position),
//                 (H.lastFontSize = e.fontSize);
//               var u = 100,
//                 a = {};
//               if (i && r)
//                 (a.emToPx = H.lastEmToPx),
//                   (a.percentToPxWidth = H.lastPercentToPxWidth),
//                   (a.percentToPxHeight = H.lastPercentToPxHeight);
//               else {
//                 var f = o(s).isSVG
//                   ? n.createElementNS("http://www.w3.org/2000/svg", "rect")
//                   : n.createElement("div");
//                 b.init(f),
//                   e.myParent.appendChild(f),
//                   v.each(
//                     ["overflow", "overflowX", "overflowY"],
//                     function (e, t) {
//                       b.CSS.setPropertyValue(f, t, "hidden");
//                     }
//                   ),
//                   b.CSS.setPropertyValue(f, "position", e.position),
//                   b.CSS.setPropertyValue(f, "fontSize", e.fontSize),
//                   b.CSS.setPropertyValue(f, "boxSizing", "content-box"),
//                   v.each(
//                     [
//                       "minWidth",
//                       "maxWidth",
...
//                     ],
//                     function (e, t) {
//                       b.CSS.setPropertyValue(f, t, u + "%");
//                     }
//                   ),
//                   b.CSS.setPropertyValue(f, "paddingLeft", u + "em"),
//                   (a.percentToPxWidth = H.lastPercentToPxWidth =
//                     (parseFloat(E.getPropertyValue(f, "width", null, !0)) ||
//                       1) / u),
//                   (a.percentToPxHeight = H.lastPercentToPxHeight =
//                     (parseFloat(E.getPropertyValue(f, "height", null, !0)) ||
//                       1) / u),
//                   (a.emToPx = H.lastEmToPx =
//                     (parseFloat(E.getPropertyValue(f, "paddingLeft")) || 1) /
//                     u),
//                   e.myParent.removeChild(f);
//               }
//               return (
//                 null === H.remToPx &&
//                   (H.remToPx =
//                     parseFloat(E.getPropertyValue(n.body, "fontSize")) || 16),
//                 null === H.vwToPx &&
//                   ((H.vwToPx = parseFloat(t.innerWidth) / 100),
//                   (H.vhToPx = parseFloat(t.innerHeight) / 100)),
//                 (a.remToPx = H.remToPx),
//                 (a.vwToPx = H.vwToPx),
//                 (a.vhToPx = H.vhToPx),
//                 b.debug >= 1 &&
//                   console.log("Unit ratios: " + JSON.stringify(a), s),
//                 a
//               );
//             }
//             if (u.begin && 0 === N)
...
//               }
//             if ("scroll" === A) {
//               var S = /^x$/i.test(u.axis) ? "Left" : "Top",
//                 C = parseFloat(u.offset) || 0,
//                 k,
//                 O,
//                 M;
//               u.container
//                 ? d.isWrapped(u.container) || d.isNode(u.container)
//                   ? ((u.container = u.container[0] || u.container),
//                     (k = u.container["scroll" + S]),
//                     (M = k + v(s).position()[S.toLowerCase()] + C))
//                   : (u.container = null)
//                 : ((k = b.State.scrollAnchor[b.State["scrollProperty" + S]]),
//                   (O =
//                     b.State.scrollAnchor[
//                       b.State[
...
//                 }),
//                 b.debug &&
//                   console.log("tweensContainer (scroll): ", a.scroll, s);
//             } else if ("reverse" === A) {
//               if (!o(s).tweensContainer) return void v.dequeue(s, u.queue);
...
//                 x.easing || delete u.easing,
//                 x.duration || delete u.duration,
//                 (u = v.extend({}, o(s).opts, u));
//               var _ = v.extend(!0, {}, o(s).tweensContainer);
//               for (var D in _)
//                 if ("element" !== D) {
//                   var P = _[D].startValue;
//                   (_[D].startValue = _[D].currentValue = _[D].endValue),
//                     (_[D].endValue = P),
//                     d.isEmptyObject(x) || (_[D].easing = u.easing),
//                     b.debug &&
//                       console.log(
...
//                 v.each(w, function (e, t) {
//                   if (RegExp("^" + E.Lists.colors.join("$|^") + "$").test(e)) {
//                     var n = h(t, !0),
//                       i = n[0],
//                       s = n[1],
//                       o = n[2];
//                     if (E.RegEx.isHex.test(i)) {
//                       for (
//                         var u = ["Red", "Green", "Blue"],
//                           a = E.Values.hexToRgb(i),
//                           f = o ? E.Values.hexToRgb(o) : r,
//                           l = 0;
//                         l < u.length;
//                         l++
//                       )
//                         w[e + u[l]] = [a[l], s, f ? f[l] : f];
//                       delete w[e];
//                     }
//                   }
//                 });
...
//                   q = F[1],
//                   R = F[2];
//                 j = E.Names.camelCase(j);
//                 var U = E.Hooks.getRoot(j),
//                   z = !1;
//                 if (
//                   o(s).isSVG ||
//                   E.Names.prefixCheck(U)[1] !== !1 ||
//                   E.Normalizations.registered[U] !== r
//                 ) {
//                   ((u.display !== r &&
//                     null !== u.display &&
//                     "none" !== u.display) ||
//                     (u.visibility && "hidden" !== u.visibility)) &&
//                     /opacity|filter/.test(j) &&
//                     !R &&
//                     0 !== I &&
//                     (R = 0),
//                     u._cacheValues && _ && _[j]
//                       ? (R === r && (R = _[j].endValue + _[j].unitType),
//                         (z = o(s).rootPropertyValueCache[U]))
//                       : E.Hooks.registered[j]
//                       ? R === r
//                         ? ((z = E.getPropertyValue(s, U)),
//                           (R = E.getPropertyValue(s, j, z)))
//                         : (z = E.Hooks.templates[U][1])
//                       : R === r && (R = E.getPropertyValue(s, j));
//                   var W,
//                     X,
//                     J,
//                     K = !1;
...
//                     b.debug &&
//                       console.log(
//                         "tweensContainer (" + j + "): " + JSON.stringify(a[j]),
//                         s
//                       );
//                 } else
//                   b.debug &&
...
//             }
//             a.element &&
//               (E.Values.addClass(s, "velocity-animating"),
//               B.push(a),
//               "" === u.queue && ((o(s).tweensContainer = a), (o(s).opts = u)),
//               (o(s).isAnimating = !0),
//               N === T - 1
//                 ? (b.State.calls.length > 1e4 &&
//                     (b.State.calls = i(b.State.calls)),
//                   b.State.calls.push([B, y, u, null, L.resolver]),
//                   b.State.isTicking === !1 && ((b.State.isTicking = !0), l()))
//                 : N++);
//           }
//           var s = this,
//             u = v.extend({}, b.defaults, x),
//             a = {},
//             c;
//           if (
//             (o(s) === r && b.init(s),
...
//             }
//           (u.easing = f(u.easing, u.duration)),
//             u.begin && !d.isFunction(u.begin) && (u.begin = null),
//             u.progress && !d.isFunction(u.progress) && (u.progress = null),
//             u.complete && !d.isFunction(u.complete) && (u.complete = null),
//             u.display !== r &&
//               null !== u.display &&
//               ((u.display = u.display.toString().toLowerCase()),
//               "auto" === u.display &&
//                 (u.display = b.CSS.Values.getDisplayType(s))),
//             u.visibility &&
//               (u.visibility = u.visibility.toString().toLowerCase()),
//             (u.mobileHA =
//               u.mobileHA && b.State.isMobile && !b.State.isGingerbread),
//             u.queue === !1
//               ? u.delay
//                 ? setTimeout(e, u.delay)
//                 : e()
//               : v.queue(s, u.queue, function (t, n) {
//                   return n === !0
//                     ? (L.promise && L.resolver(y), !0)
//                     : ((b.velocityQueueEntryFlag = !0), void e(t));
//                 }),
//             ("" !== u.queue && "fx" !== u.queue) ||
//               "inprogress" === v.queue(s)[0] ||
//               v.dequeue(s);
//         }
//         var a =
//             arguments[0] &&
//             ((v.isPlainObject(arguments[0].properties) &&
...
//         if (
//           (d.isWrapped(this)
//             ? ((h = !1), (m = 0), (y = this), (p = this))
//             : ((h = !0),
//               (m = 1),
//               (y = a ? arguments[0].elements : arguments[0])),
//           (y = s(y)))
//         ) {
//           a
//             ? ((w = arguments[0].properties), (x = arguments[0].options))
//             : ((w = arguments[m]), (x = arguments[m + 1]));
//           var T = y.length,
//             N = 0;
//           if ("stop" !== w && !v.isPlainObject(x)) {
//             var C = m + 1;
//             x = {};
//             for (var k = C; k < arguments.length; k++)
//               d.isArray(arguments[k]) ||
//               (!/fast|normal|slow/i.test(arguments[k].toString()) &&
//                 !/^\d/.test(arguments[k]))
//                 ? d.isString(arguments[k]) || d.isArray(arguments[k])
//                   ? (x.easing = arguments[k])
//                   : d.isFunction(arguments[k]) && (x.complete = arguments[k])
//                 : (x.duration = arguments[k]);
//           }
//           var L = { promise: null, resolver: null, rejecter: null };
//           h &&
//             b.Promise &&
//             (L.promise = new b.Promise(function (e, t) {
...
//               var O = [];
//               return (
//                 v.each(b.State.calls, function (e, t) {
//                   t &&
//                     v.each(t[1], function (n, i) {
//                       var s = d.isString(x) ? x : "";
//                       return x !== r && t[2].queue !== s
//                         ? !0
//                         : void v.each(y, function (t, n) {
//                             n === i &&
//                               (x !== r &&
//                                 (v.each(v.queue(n, s), function (e, t) {
//                                   d.isFunction(t) && t(null, !0);
//                                 }),
//                                 v.queue(n, s, [])),
//                               o(n) &&
//                                 "" === s &&
//                                 v.each(o(n).tweensContainer, function (e, t) {
...
//                   c(t, !0);
//                 }),
//                 L.promise && L.resolver(y),
//                 e()
//               );
//             default:
//               if (!v.isPlainObject(w) || d.isEmptyObject(w)) {
//                 if (d.isString(w) && b.Sequences[w]) {
//                   var M = v.extend({}, x),
//                     _ = M.duration,
//                     D = M.delay || 0;
//                   return (
//                     M.backwards === !0 && (y = y.reverse()),
//                     v.each(y, function (e, t) {
//                       parseFloat(M.stagger)
//                         ? (M.delay = D + parseFloat(M.stagger) * e)
//                         : d.isFunction(M.stagger) &&
//                           (M.delay = D + M.stagger.call(t, e, T)),
//                         M.drag &&
//                           ((M.duration =
//                             parseFloat(_) ||
//                             (/^(callout|transition)/.test(w) ? 1e3 : g)),
//                           (M.duration = Math.max(
//                             M.duration *
//                               (M.backwards ? 1 - e / T : (e + 1) / T),
//                             0.75 * M.duration,
//                             200
//                           ))),
//                         b.Sequences[w].call(
...
//                 return (
//                   L.promise ? L.rejecter(new Error(P)) : console.log(P), e()
//                 );
//               }
//               A = "start";
//           }
...
//             d.isNode(t) && u.call(t);
//           });
//           var M = v.extend({}, b.defaults, x),
//             j;
//           if (((M.loop = parseInt(M.loop)), (j = 2 * M.loop - 1), M.loop))
//             for (var F = 0; j > F; F++) {
//               var I = { delay: M.delay };
//               F === j - 1 &&
//                 ((I.display = M.display),
//                 (I.visibility = M.visibility),
//                 (I.complete = M.complete)),
//                 S(y, "reverse", I);
//             }
//           return e();
//         }
//       };
//       (b = v.extend(S, b)), (b.animate = S);
...
//           }),
//         (e.Velocity = b),
//         e !== t && ((e.fn.velocity = S), (e.fn.velocity.defaults = b.defaults)),
//         v.each(["Down", "Up"], function (e, t) {
//           b.Sequences["slide" + t] = function (e, n, i, s, o, u) {
//             var a = v.extend({}, n),
//               f = a.begin,
//               l = a.complete,
//               c = {
...
//                 l && l.call(o, o), u && u.resolver(o);
//               }),
//               b(e, c, a);
//           };
//         }),
//         v.each(["In", "Out"], function (e, t) {
//           b.Sequences["fade" + t] = function (e, n, i, s, o, u) {
//             var a = v.extend({}, n),
//               f = { opacity: "In" === t ? 1 : 0 },
//               l = a.complete;
//             (a.complete =
...
//                     l && l.call(o, o), u && u.resolver(o);
//                   }),
//               a.display === r && (a.display = "In" === t ? "auto" : "none"),
//               b(this, f, a);
//           };
//         }),
//         b
...
//   }),
//   define("components/menuScript", ["jquery", "velocity"], function (e) {
//     var t = {
//       get: {
//         sticker: e("#sticker"),
//         menu: e("#nav"),
...
//         t.get.menuItem.each(function () {
//           e(this).on("click tap", function (t) {
//             t.preventDefault();
//             var n = e("a", e(this)).attr("href"),
//               r = e(n).offset().top;
//             e("html, body").stop().animate({ scrollTop: r }, 900, "swing");
//           });
//         });
//       },
//     };
...
//           return null == e
//             ? !1
//             : (e.length !== +e.length && (e = p.values(e)),
//               p.indexOf(e, t) >= 0);
//         }),
...
//         for (
//           var t,
//             n = e && e.length === +e.length ? e : p.values(e),
//             r = n.length,
//             i = Array(r),
//             s = 0;
//           r > s;
//           s++
//         )
//           (t = p.random(0, s)), t !== s && (i[s] = i[t]), (i[t] = n[s]);
//         return i;
//       }),
...
//           : p.shuffle(e).slice(0, Math.max(0, t));
//       }),
...
//           : null == t || n
//           ? e[e.length - 1]
//           : o.call(e, Math.max(e.length - t, 0));
//       }),
//       (p.rest =
//         p.tail =
//         p.drop =
...
//         if (null == e) return [];
//         for (
//           var t = p.max(arguments, "length").length, n = Array(t), r = 0;
//           t > r;
//           r++
//         )
...
//         if (n) {
//           if ("number" != typeof n)
//             return (r = p.sortedIndex(e, t)), e[r] === t ? r : -1;
...
//         var r = e.length;
//         for (
//           "number" == typeof n && (r = 0 > n ? r + n + 1 : Math.min(r, n + 1));
//           --r >= 0;
...
//         for (
//           var r = Math.max(Math.ceil((t - e) / n), 0), i = Array(r), s = 0;
//           r > s;
//           s++, e += n
//         )
//           i[s] = e;
...
//             t > f && f > 0
//               ? (r = setTimeout(a, t - f))
//               : ((r = null), n || ((u = e.apply(s, i)), r || (s = i = null)));
//           };
//         return function () {
...
//           for (
//             ;
//             f-- && ((c = h[f]), (l = p.has(t, c) && b(e[c], t[c], n, r)));
...
//             t.keys !== r &&
//               (u.opts.keys = t.keys
//                 ? n.extend({}, u.defaults.keys, t.keys)
//                 : !1),
//             (u.group = e),
...
//                 !e.canShrink &&
//                 (0 < s || 0 < i
//                   ? u.prev(0 < s ? "down" : "left")
//                   : (0 > s || 0 > i) && u.next(0 > s ? "up" : "right"),
//                 t.preventDefault());
//             }));
//       },
//       trigger: function (e, t) {
...
//             e.wrap.stop(!0).trigger("onReset").remove(), (u.coming = null);
//           else {
//             t &&
...
//               case "html":
//                 e.selector
//                   ? (r = n("<div>").html(r).find(e.selector))
//                   : c(r) &&
...
//               u.bindEvents(),
//               u.isOpened
//                 ? t.prevMethod && u.transitions[t.prevMethod]()
//                 : n(".fancybox-wrap")
//                     .not(e.wrap)
//                     .stop(!0)
//                     .trigger("onReset")
...
//           (M = m),
//           a.fitToView &&
//             ((h = Math.min(e.w - C, h)), (m = Math.min(e.h - k, m))),
//           (C = e.w - x),
//           (T = e.h - T),
//           a.aspectRatio
//             ? (i > h && ((i = h), (f = d(i / _))),
...
//             r = { opacity: 0.1 };
//           n &&
//             ((r = this.getOrigPosition()), e.closeOpacity && (r.opacity = 0.1)),
//             u.wrap.animate(r, {
...
//           (t = n.support),
//             (s = n('<div style="position:fixed;top:20px;"></div>').appendTo(
//               "body"
//             ));
...
//                     a >= 1 &&
//                     (u > a
//                       ? ((n = Math.floor(n / a)), (i = o))
//                       : ((n = s), (i = Math.floor(i / u)))),
//                   e(this).css({
//                     width: n,
//                     height: i,
...
//               Math.floor(
//                 e(window).width() * 0.5 -
//                   (n.index * this.width + this.width * 0.5)
//               )
//             );
//       },
...
//     };
//   })(jQuery),
//   define("fancyThumb", ["jquery", "fancy"], function () {}),
//   (function (e) {
//     var t = {},
//       n,
//       r,
...
//           var v;
//           if (!(v = n)) {
//             var m = { height: s.innerHeight, width: s.innerWidth };
//             !m.height &&
//               ((v = i.compatMode) || !e.support.boxModel) &&
//               ((v = "CSS1Compat" === v ? o : i.body),
//               (m = { height: v.clientHeight, width: v.clientWidth })),
//               (v = m);
//           }
//           n = v;
//           for (
...
//               if (!r || !n) break;
//               b.top + g > r.top &&
//               b.top < r.top + n.height &&
//               b.left + y > r.left &&
//               b.left < r.left + n.width
//                 ? ((y =
//                     r.left > b.left
//                       ? "right"
//                       : r.left + n.width < b.left + y
//                       ? "left"
//                       : "both"),
//                   (g =
//                     r.top > b.top
//                       ? "bottom"
//                       : r.top + n.height < b.top + g
//                       ? "top"
//                       : "both"),
//                   (b = y + "-" + g),
//                   (!m || m !== b) &&
//                     v.data("inview", b).trigger("inview", [!0, y, g]))
//                 : m && v.data("inview", !1).trigger("inview", [!1]);
//             }
//         }
//       }, 250);
//   })(jQuery),
...
//     function c() {
//       var e = !1;
//       e && N("keydown", y), t.keyboardSupport && !e && T("keydown", y);
//     }
//     function h() {
...
//               ((l = !0),
//               setTimeout(function () {
//                 (i.style.height = document.height + "px"), (l = !1);
//               }, 500));
//           };
//         (i.style.height = "auto"), setTimeout(h, 10);
//         if (o.offsetHeight <= a) {
//           var p = document.createElement("div");
//           (p.style.clear = "both"), e.appendChild(p);
//         }
//       }
//       !t.fixedBackground &&
//         !n &&
...
//           var u = (1 + 30 / o) / 2;
//           u > 1 && ((u = Math.min(u, t.accelerationMax)), (n *= u), (r *= u));
//         }
//         v = +new Date();
//       }
//       p.push({
...
//               v = o - h.start,
//               m = v >= t.animationTime,
//               g = m ? 1 : v / t.animationTime;
//             t.pulseAlgorithm && (g = D(g));
...
//           a
//             ? window.scrollBy(u, l)
//             : (u && (e.scrollLeft += u), l && (e.scrollTop += l)),
//             !n && !r && (p = []),
//             p.length ? M(f, e, i / t.frameRate + 1) : (d = !1);
//         };
//       M(f, e, 0), (d = !0);
//     }
//     function g(e) {
...
//       if (!t.touchpadSupport && A(o)) return !0;
...
//       )
//         return !0;
//       if (C(n, "button") && e.keyCode === l.spacebar) return !0;
//       var i,
//         s = 0,
//         o = 0,
//         a = x(u),
//         f = a.clientHeight;
//       a == document.body && (f = window.innerHeight);
//       switch (e.keyCode) {
//         case l.up:
//           o = -t.arrowScroll;
//           break;
...
//         t.push(e);
//         if (n === e.scrollHeight) {
//           if (!r || o.clientHeight + 10 < n) return S(t, document.body);
//         } else if (e.clientHeight + 10 < e.scrollHeight) {
//           overflow = getComputedStyle(e, "").getPropertyValue("overflow-y");
//           if (overflow === "scroll" || overflow === "auto") return S(t, e);
//         }
...
//     function k(e, t) {
//       (e = e > 0 ? 1 : -1), (t = t > 0 ? 1 : -1);
//       if (i.x !== e || i.y !== t) (i.x = e), (i.y = t), (p = []), (v = 0);
//     }
//     function A(e) {
//       if (!e) return;
//       (e = Math.abs(e)), f.push(e), f.shift(), clearTimeout(L);
...
//         : e <= 0
//         ? 0
//         : (t.pulseNormalize == 1 && (t.pulseNormalize /= _(1)), _(e));
//     }
//     var e = {
//         frameRate: 150,
//         animationTime: 400,
...
//       ? (H = "wheel")
//       : "onmousewheel" in document.createElement("div") && (H = "mousewheel"),
//       H && P && (T(H, g), T("mousedown", b), T("load", h));
//   })(),
...
//       if (
//         !e.Velocity.version ||
//         (e.Velocity.version.major <= 0 &&
//           e.Velocity.version.minor <= 11 &&
//           e.Velocity.version.patch < 8)
//       ) {
//         var i =
...
//       }
//       (e.Velocity.RegisterUI = function (t, n) {
//         function i(t, n, r, i) {
//           var s = 0,
//             o;
//           e.Velocity.Utilities.each(t.nodeType ? [t] : t, function (t, n) {
//             i && (r += t * i),
//               (o = n.parentNode),
//               e.Velocity.Utilities.each(
//                 [
//                   "height",
//                   "paddingTop",
//                   "paddingBottom",
...
//                 ],
//                 function (t, r) {
//                   s += parseFloat(e.Velocity.CSS.getPropertyValue(n, r));
//                 }
//               );
//           }),
//             e.Velocity.animate(
...
//                 queue: !1,
//                 easing: "ease-in-out",
//                 duration: r * ("In" === n ? 0.6 : 1),
//               }
//             );
//         }
//         return (
//           (e.Velocity.Sequences[t] = function (s, o, u, f, l, c) {
//             function h() {
//               (o.display !== r && "none" !== o.display) ||
//                 !/Out$/.test(t) ||
//                 e.Velocity.Utilities.each(
//                   l.nodeType ? [l] : l,
//                   function (t, n) {
//                     e.Velocity.CSS.setPropertyValue(n, "display", "none");
//                   }
//                 ),
//                 o.complete && o.complete.call(l, l),
//                 c && c.resolver(l || s);
//             }
//             for (var p = u === f - 1, d = 0; d < n.calls.length; d++) {
//               var v = n.calls[d],
//                 m = v[0],
//                 g = o.duration || n.defaultDuration || 1e3,
//                 y = v[1],
//                 b = v[2] || {},
//                 w = {};
//               if (
...
//                   0 === u &&
//                     (w.begin = function () {
//                       o.begin && o.begin.call(l, l);
//                       var e = t.match(/(In|Out)$/);
//                       o.animateParentHeight &&
//                         e &&
//                         i(l, e[0], g + w.delay, o.stagger);
//                     }),
//                   null !== o.display)
//                 )
//                   if (o.display !== r && "none" !== o.display)
//                     w.display = o.display;
//                   else if (/In$/.test(t)) {
//                     var E = e.Velocity.CSS.Values.getDisplayType(s);
//                     w.display = "inline" === E ? "inline-block" : E;
//                   }
//                 o.visibility &&
//                   "hidden" !== o.visibility &&
...
//                 ((w.complete = function () {
//                   if (n.reset) {
//                     for (var t in n.reset) {
//                       var r = n.reset[t];
//                       ("string" == typeof r || "number" == typeof r) &&
//                         (n.reset[t] = [n.reset[t], n.reset[t]]);
//                     }
//                     var i = { duration: 0, queue: !1 };
//                     p && (i.complete = h), e.Velocity.animate(s, n.reset, i);
//                   } else p && h();
//                 }),
//                 "hidden" === o.visibility && (w.visibility = o.visibility)),
//                 e.Velocity.animate(s, m, w);
//             }
//           }),
//           e.Velocity
//         );
//       }),
//         (e.Velocity.RegisterUI.packagedEffects = {
//           "callout.bounce": {
//             defaultDuration: 550,
//             calls: [
//               [{ translateY: -30 }, 0.25],
...
//             defaultDuration: 800,
//             calls: [
//               [{ scaleX: 0.95, scaleY: 0.95 }, 0.4],
//               [{ scaleX: 1.1, scaleY: 1.1, translateZ: 0 }, 0.4],
//               [{ opacity: [0, 1], scaleX: 0.3, scaleY: 0.3 }, 0.2],
//             ],
//             reset: { scaleX: 1, scaleY: 1 },
//           },
...
//           },
//         });
//       for (var s in e.Velocity.RegisterUI.packagedEffects)
//         e.Velocity.RegisterUI(s, e.Velocity.RegisterUI.packagedEffects[s]);
//     })(window.jQuery || window.Zepto || window, window, document);
//   }),
//   (function (e) {
...
//         return (
//           this.css("height", ""),
//           e.each(e.fn.matchHeight._groups, function (e, t) {
...
//           e.fn.matchHeight._groups.push({ elements: this, byRow: t }),
//           e.fn.matchHeight._apply(this, t),
//           this);
//     }),
...
//           a = e("html").outerHeight(!0);
//         return (
//           n &&
//             (s.each(function () {
//               var t = e(this),
//                 n =
//                   "inline-block" === t.css("display")
//                     ? "inline-block"
//                     : "block";
//               t.css({
//                 display: n,
...
//             var r = e(n),
//               s = 0,
//               o = r.parents().add(r).filter(":hidden");
//             o.css({ display: "block" }),
//               r.each(function () {
//                 var t = e(this),
//                   n =
...
//               });
//           }),
//           e.fn.matchHeight._maintainScroll &&
//             e(window).scrollTop((u / a) * e("html").outerHeight(!0)),
//           this
//         );
//       }),
...
//           });
//       }),
//       (e.fn.matchHeight._groups = []),
//       (e.fn.matchHeight._throttle = 80),
//       (e.fn.matchHeight._maintainScroll = !1);
//     var t = -1,
//       n = -1;
//     (e.fn.matchHeight._update = function (r) {
//       if (r && "resize" === r.type) {
//         r = e(window).width();
//         if (r === t) return;
//         t = r;
...
//     }),
//       e(e.fn.matchHeight._applyDataApi),
//       e(window).bind("load resize orientationchange", e.fn.matchHeight._update);
//     var r = function (t) {
//         var n = null,
//           r = [];
//         return (
...
//               o = 0 < r.length ? r[r.length - 1] : null;
//             null === o
//               ? r.push(t)
//               : 1 >= Math.floor(Math.abs(n - s))
//               ? (r[r.length - 1] = o.add(t))
//               : r.push(t),
//               (n = s);
//           }),
//           r
...
//             (o = 0),
//             0 === s && n.call(u[0]),
//             e.each(l, function (i, l) {
//               var h = new Image();
//               e(h).on("load." + t + " error." + t, function (e) {
//                 return (
//                   o++,
//                   r.call(l.element, o, s, "load" == e.type),
//                   o == s ? (n.call(u[0]), !1) : void 0
//                 );
//               }),
//                 (h.src = l.src);
//             });
...
//       var n = {
//         select: {
//           colors: t(".prod-colors-list"),
//           numbersTime: 2e3,
//           videoBlock: t(".video-block .player"),
//           timeOut: null,
//         },
//         init: function () {
//           this.bindUiActions();
//         },
//         bindUiActions: function () {
//           t(".stats-item").css("opacity", "0"),
//             this.bindTeamHover(),
//             this.bindMapToggle(),
//             t(".news-section").waitForImages(function () {
//               n.matchNewsHeight();
//             }),
//             n.setLogoHeight(),
//             t(window).resize(
//               e.debounce(function () {
//                 n.setLogoHeight(), n.matchNewsHeight(), n.setTopPadding();
//               }, 500)
//             ),
//             setInterval(function () {
//               n.animateWhyus();
//             }, 3e3),
//             t(".js-procede-btn").click(function () {
//               t("#products").velocity("scroll", {
//                 container: "",
//                 duration: 500,
//               });
//             }),
...
//           t(".parallax-header").length &&
//             t(".page-content").css(
//               "padding-top",
//               t(window).innerHeight() + "px"
//             ),
//             t(".js-bgi-v").length &&
//               t(".js-bgi-v").css("height", t(window).innerHeight() + "px");
//         },
//         animateWhyus: function () {
//           var e = t(".why-us-image");
//           e.hasClass("left-side")
//             ? e.removeClass("left-side").addClass("right-side")
//             : e.hasClass("right-side")
//             ? e.removeClass("right-side")
//             : e.addClass("left-side");
//         },
//         matchNewsHeight: function () {
//           t(".news-image", t(".js-news-item")).each(function () {
//             t(this).removeClass("large-image");
//             var e = t(this).height(),
//               n = t(this).parent().height();
//             e < n && t(this).addClass("large-image");
//           }),
//             t(".js-news-item").matchHeight();
//         },
//         setLogoHeight: function () {
//           t(".logo-img").css("max-height", t(window).innerHeight() * 0.6),
//             t(".logo-img").css({
//               "max-height": t(window).innerHeight() * 0.6,
//               "max-width": t(window).innerWidth() * 0.85,
//             });
//         },
//         bindMapToggle: function () {
//           t(".js-map-container").velocity({ translateY: "-130%" }, 10),
//             t(".js-map-view").on("click tap", function () {
//               t(".js-map-container").velocity(
//                 { translateY: ["0", "-130%"] },
//                 700,
//                 function () {
//                   t(".js-map-container").addClass("is-active");
//                 }
//               );
//             }),
//             t(".js-form-view").on("click tap", function () {
//               t(".js-map-container").velocity("reverse", function () {
//                 t(".js-map-container").removeClass("is-active");
//               });
//             }),
//             t(window).keyup(function (e) {
//               e.preventDefault(),
//                 e.keyCode === 27 &&
//                   t(".js-map-container").hasClass("is-active") &&
//                   t(".js-map-container")
...
//           t(".about-team").hover(
//             function () {
//               t(".js-item-info", t(this))
//                 .stop()
//                 .velocity("stop")
//                 .velocity({ opacity: "0" }, 250),
//                 t(".team-social", t(this))
//                   .stop()
//                   .delay(250)
//                   .each(function (e) {
//                     t(this)
...
//                 .stop()
//                 .velocity("stop")
//                 .velocity({ opacity: "1" }, { duration: 250, delay: 200 }),
//                 t(".team-social", t(this))
//                   .stop()
//                   .velocity("stop")
//                   .velocity({ translateY: "-20px", opacity: "0" }, 250);
//             }
//           );
//         },
//         createVideo: function () {
//           n.select.videoBlock.mb_YTPlayer(), n.checkButton();
//         },
//         animNumbers: function () {
//           t("#hours").animateNumbers(24, !0, n.select.numbersTime, "linear"),
//             t("#sold").animateNumbers(2443, !0, n.select.numbersTime, "linear"),
//             t("#happy").animateNumbers(98, !0, n.select.numbersTime, "linear"),
//             t("#experience").animateNumbers(
//               20,
//               !0,
...
//             },
//           }),
//             t(".view-product-gallery", n).click(function () {
//               var e = t(".fancyBox-gallery li", n).first();
//               t(".fancybox-thumb", e).click();
//             });
//         },
//       };
//       n.init();
...
//       t,
//       n,
//       r = typeof window != "undefined" && window.document,
//       i = !r,
//       s = r ? document : null,
//       o = [];
//     if (r) {
...
//         (this.$element = e(t)),
//         (this.drag = e.extend({}, h)),
//         (this.state = e.extend({}, p)),
//         (this.e = e.extend({}, d)),
//         (this._plugins = {}),
//         (this._supress = {}),
//         (this._current = null),
...
//       if (e.touches === r) {
//         if (e.pageX !== r) return { x: e.pageX, y: e.pageY };
//         if (e.pageX === r) return { x: e.clientX, y: e.clientY };
//       }
//     }
//     function o(e) {
//       var t,
...
//         s = e;
//       for (t in s)
//         if (((r = s[t]), "undefined" != typeof i.style[r]))
//           return (i = null), [r, t];
//       return [!1];
//     }
//     function u() {
...
//             (t.length !== e.length || (!this.settings.loop && e.length > 0)) &&
...
//                 : 0;
//             for (e = 0, t = Math.abs(i / 2); t > e; e++)
//               i > 0
//                 ? (this.$stage
//                     .children()
//                     .eq(r.length + n.length - 1)
//                     .remove(),
//                   n.pop(),
...
//                 : (n.push(n.length / 2),
//                   this.$stage.append(
//                     r[n[n.length - 1]].clone().addClass("cloned")
//                   ),
...
//                 }).length > 0)
//             )
//               for (t = 0, n = this._coordinates.length; n > t; t++)
//                 (i.width =
...
//               u = o + this.width() * i,
//               a = [];
//             for (n = 0, r = this._coordinates.length; r > n; n++)
//               (e = this._coordinates[n - 1] || 0),
//                 (t = Math.abs(this._coordinates[n]) + s * i),
//                 ((this.op(e, "<=", o) && this.op(e, ">", u)) ||
//                   (this.op(t, "<", o) && this.op(t, ">", u))) &&
//                   a.push(n);
//             this.$stage
...
//           (null === this.settings || this._breakpoint !== r) &&
//             (this.trigger("change", {
...
//       }),
//       (i.prototype.onDragStart = function (r) {
//         var i, o, u, a;
//         if (
//           ((i = r.originalEvent || r || t.event),
//           3 === i.which || this.state.isTouch)
//         )
//           return !1;
//         if (
//           ("mousedown" === i.type && this.$stage.addClass("owl-grab"),
//           this.trigger("drag"),
...
//                 )),
//                 (f = this.settings.pullDrag ? this.drag.distance / 5 : 0),
//                 (this.drag.currentX = Math.max(
//                   Math.min(this.drag.currentX, u + f),
//                   a + f
//                 ))),
...
//             (i > 3 || r > 300) && this.removeClick(this.drag.targetEl),
...
//               this.drag.updatedX !== this.coordinates(s) ||
//               this.transitionEnd(),
//             (this.drag.distance = 0),
//             e(n).off(".owl.dragEvents");
//         }
//       }),
//       (i.prototype.removeClick = function (n) {
...
//                     : this.op(t, "<", o) &&
//                       this.op(t, ">", s[e + 1] || o - i) &&
//                       (n = "left" === this.state.direction ? e + 1 : e),
//                   -1 === n
//                 );
//               }, this)
//             ),
...
//               ? (n = t = this.minimum())
//               : this.op(t, "<", s[this.maximum()]) && (n = t = this.maximum())),
//           n
//         );
//       }),
...
//         return !e.isNumeric(t) || 1 > i
//           ? r
//           : (t = this._clones.length
//               ? ((t % i) + i) % i
//               : Math.max(this.minimum(n), Math.min(this.maximum(n), t)));
//       }),
...
//               (r = this.coordinates(i)) && !(r * revert >= n);
...
//                 (n +=
//                   ((this.width() - n + (this._coordinates[t - 1] || 0)) / 2) *
...
//           u < this.settings.items && a === !1
//             ? ((s = o + this._items.length), this.reset(s))
//             : u >= f - this.settings.items &&
//               a === !0 &&
//               ((s = o - this._items.length), this.reset(s)),
...
//             ),
//           this.reset(
//             e.isNumeric(this.settings.startPosition)
...
//                   i.css("opacity", 1),
//                   n >= t.length &&
//                     ((r.state.imagesLoaded = !0), r.initialize());
//               }),
//               (s.src =
//                 i.attr("src") ||
//                 i.attr("data-src") ||
...
//           this.settings.responsive !== !1 && e(t).off("resize.owl.carousel"),
//           this.transitionEndVendor &&
//             this.off(
//               this.$stage.get(0),
//               this.transitionEndVendor,
...
//       }),
//       (i.prototype.trigger = function (t, n, r) {
...
//             e.extend({ relatedTarget: this }, i, n)
//           );
//         return (
//           this._supress[t] ||
...
//         if (((this.support3d = f()), this.support3d)) {
...
//             e(this).data("owlCarousel", new i(this, t));
//         });
//       }),
...
//           this._core.settings.lazyLoad && ((f = "data-src"), (l = "owl-lazy")),
//           u.length
//             ? (h(u.attr(f)), u.remove(), !1)
//             : void ("youtube" === n.type
...
//           u = o.width || "100%",
//           f = o.height || this._core.$stage.height();
//         "youtube" === o.type
//           ? (n =
//               '<iframe width="' +
//               u +
...
//         return (
//           r &&
//             e(r).parent().hasClass("owl-video-frame") &&
...
//               .prop("outerHTML"),
//           ]),
//           (r.navContainer && r.dotsContainer) ||
//             (this._controls.$container = e("<div>")
//               .addClass(r.controlsClass)
//               .appendTo(this.$element)),
//           (this._controls.$indicators = r.dotsContainer
//             ? e(r.dotsContainer)
//             : e("<div>")
//                 .hide()
//                 .addClass(r.dotsClass)
//                 .appendTo(this._controls.$container)),
//           this._controls.$indicators.on(
//             "click",
//             "div",
//             e.proxy(function (t) {
//               var n = e(t.target).parent().is(this._controls.$indicators)
//                 ? e(t.target).index()
//                 : e(t.target).parent().index();
//               t.preventDefault(), this.to(n, r.dotsSpeed);
//             }, this)
//           ),
//           (t = r.navContainer
//             ? e(r.navContainer)
...
//         )
//           for (this._pages = [], e = i, t = 0, n = 0; s > e; e++)
//             (t >= o || 0 === t) &&
...
//             i.loop ||
//             i.navRewind ||
//             (this._controls.$previous.toggleClass("disabled", 0 >= s),
...
//           size:
//             n &&
//             (n.center || n.autoWidth || n.dotData ? 1 : n.dotsEach || n.items),
//         };
//       }),
...
//             return e ? void this._core.to(r, !1, !0) : !1;
//           }, this)
//         );
//     };
...
//     ["domReady", "underscore", "jquery", "owlCarousel", "matchH", "waitImg"],
//     function (e, t, n) {
//       var r = {
//         select: {
//           partners: n(".partners-carousel .slides"),
//           reviews: n(".testimonials-list"),
//           news: n(".news-images-list"),
//         },
//         init: function () {
//           this.bindUiActions();
//         },
...
//             dots: !1,
//           };
//           r.initCarousel(this.select.news, e),
//             this.select.news.waitForImages(function () {
//               n(window).resize(
//                 t.debounce(function () {
//                   n(".owl-item", r.select.news).height(
//                     n(".news-image-block").height()
//                   );
//                 }, 250)
//               ),
//                 n(".owl-item", r.select.news).height(
...
//             loop: !0,
//           };
//           n(".testimonial-item").matchHeight(),
//             r.initCarousel(this.select.reviews, e);
//         },
...
//             },
//           };
//           r.initCarousel(this.select.partners, e);
//         },
//       };
//       r.init();
//     }
...
//       function r() {
//         v.contentContainer = e(v.contentContainer || m);
//         switch (v.content) {
//           case "iframe":
//             var t = e(
//               '<iframe class="b-iframe" ' + v.iframeAttr + "></iframe>"
//             );
//             t.appendTo(v.contentContainer),
//               (D = m.outerHeight(!0)),
//               (P = m.outerWidth(!0)),
//               i(),
//               t.attr("src", v.loadUrl),
//               h(v.loadCallback);
//             break;
//           case "image":
//             i(),
//               e("<img />")
//                 .load(function () {
//                   h(v.loadCallback), o(e(this));
//                 })
//                 .attr("src", v.loadUrl)
//                 .hide()
//                 .appendTo(v.contentContainer);
//             break;
//           default:
//             i(),
//               e('<div class="b-ajax-wrapper"></div>')
//                 .load(v.loadUrl, v.loadData, function () {
//                   h(v.loadCallback), o(e(this));
//                 })
//                 .hide()
//                 .appendTo(v.contentContainer);
...
//       function i() {
//         v.modal &&
//           e('<div class="b-modal ' + C + '"></div>')
//             .css({
//               backgroundColor: v.modalColor,
//               position: "fixed",
//               top: 0,
//               right: 0,
//               bottom: 0,
...
//             .css({
//               left:
//                 "slideIn" == v.transition || "slideBack" == v.transition
//                   ? "slideBack" == v.transition
//                     ? g.scrollLeft() + S
//                     : -1 * (_ + P)
//                   : l(!((!v.follow[0] && A) || O)),
//               position: v.positionStyle || "absolute",
//               top:
//                 "slideDown" == v.transition || "slideUp" == v.transition
//                   ? "slideUp" == v.transition
//                     ? g.scrollTop() + E
//                     : M + -1 * D
//                   : c(!((!v.follow[1] && L) || O)),
//               "z-index": v.zIndex + N + 1,
//             })
//             .each(function () {
//               v.appending && e(this).appendTo(v.appendTo);
//             }),
//           a(!0);
//       }
//       function s() {
//         return (
//           v.modal &&
//             e(".b-modal." + m.data("id")).fadeTo(v.speed, 0, function () {
//               e(this).remove();
//             }),
//           v.scrollBar || e("html").css("overflow", "auto"),
//           e(".b-modal." + C).unbind("click"),
//           g.unbind("keydown." + C),
//           w
//             .unbind("." + C)
//             .data(
//               "bPopup",
//               0 < w.data("bPopup") - 1 ? w.data("bPopup") - 1 : null
//             ),
//           m
//             .undelegate(".bClose, ." + v.closeClass, "click." + C, s)
//             .data("bPopup", null),
//           a(),
//           !1
//         );
...
//           n = e.height(),
//           r = {};
//         v.contentContainer.css({ height: n, width: t }),
//           n >= m.height() && (r.height = m.height()),
//           t >= m.width() && (r.width = m.width()),
//           (D = m.outerHeight(!0)),
//           (P = m.outerWidth(!0)),
//           p(),
//           v.contentContainer.css({ height: "auto", width: "auto" }),
//           (r.left = l(!((!v.follow[0] && A) || O))),
//           (r.top = c(!((!v.follow[1] && L) || O))),
//           m.animate(r, 250, function () {
//             e.show(), (k = d());
//           });
//       }
//       function u() {
//         w.data("bPopup", N),
//           m.delegate(".bClose, ." + v.closeClass, "click." + C, s),
//           v.modalClose &&
//             e(".b-modal." + C)
//               .css("cursor", "pointer")
//               .bind("click", s),
//           x ||
//             (!v.follow[0] && !v.follow[1]) ||
//             w
//               .bind("scroll." + C, function () {
//                 k &&
//                   m
//                     .dequeue()
//                     .animate(
//                       {
//                         left: v.follow[0] ? l(!O) : "auto",
//                         top: v.follow[1] ? c(!O) : "auto",
//                       },
//                       v.followSpeed,
//                       v.followEasing
//                     );
...
//                 (E = y.innerHeight || w.height()),
//                   (S = y.innerWidth || w.width());
//                 if ((k = d()))
//                   clearTimeout(H),
//                     (H = setTimeout(function () {
//                       p(),
//                         m.dequeue().each(function () {
//                           O
//                             ? e(this).css({ left: _, top: M })
//                             : e(this).animate(
//                                 {
//                                   left: v.follow[0] ? l(!0) : "auto",
//                                   top: v.follow[1] ? c(!0) : "auto",
//                                 },
//                                 v.followSpeed,
//                                 v.followEasing
//                               );
...
//               }),
//           v.escClose &&
//             g.bind("keydown." + C, function (e) {
//               27 == e.which && s();
//             });
//       }
//       function a(e) {
//         function t(t) {
//           m.css({ display: "block", opacity: 1 }).animate(
//             t,
//             v.speed,
//             v.easing,
//             function () {
...
//           );
//         }
//         switch (e ? v.transition : v.transitionClose || v.transition) {
//           case "slideIn":
//             t({
//               left: e
//                 ? l(!((!v.follow[0] && A) || O))
//                 : g.scrollLeft() - (P || m.outerWidth(!0)) - T,
//             });
//             break;
//           case "slideBack":
//             t({
//               left: e ? l(!((!v.follow[0] && A) || O)) : g.scrollLeft() + S + T,
//             });
//             break;
//           case "slideDown":
//             t({
//               top: e
//                 ? c(!((!v.follow[1] && L) || O))
//                 : g.scrollTop() - (D || m.outerHeight(!0)) - T,
//             });
//             break;
//           case "slideUp":
//             t({
//               top: e ? c(!((!v.follow[1] && L) || O)) : g.scrollTop() + E + T,
//             });
//             break;
//           default:
//             m.stop().fadeTo(v.speed, e ? 1 : 0, function () {
//               f(e);
//             });
//         }
//       }
//       function f(e) {
//         e
//           ? (u(), h(n), v.autoClose && setTimeout(s, v.autoClose))
//           : (m.hide(),
//             h(v.onClose),
//             v.loadUrl &&
//               (v.contentContainer.empty(),
//               m.css({ height: "auto", width: "auto" })));
//       }
//       function l(e) {
//         return e ? _ + g.scrollLeft() : _;
//       }
//       function c(e) {
//         return e ? M + g.scrollTop() : M;
//       }
//       function h(t) {
//         e.isFunction(t) && t.call(m);
//       }
//       function p() {
//         (M = L
//           ? v.position[1]
//           : Math.max(0, (E - m.outerHeight(!0)) / 2 - v.amsl)),
//           (_ = A ? v.position[0] : (S - m.outerWidth(!0)) / 2),
//           (k = d());
//       }
//       function d() {
//         return E > m.outerHeight(!0) && S > m.outerWidth(!0);
//       }
//       e.isFunction(t) && ((n = t), (t = null));
//       var v = e.extend({}, e.fn.bPopup.defaults, t);
//       v.scrollBar || e("html").css("overflow", "hidden");
//       var m = this,
//         g = e(document),
//         y = window,
//         w = e(y),
...
//     ["jquery", "bPopup", "velocity", "velocityUi"],
//     function (e) {
//       var t = {
//         data: {
//           form: e(".form-popup-block"),
//           error: e(".error-block"),
//           succes: e(".success-block"),
//           order: e(".order-form-block"),
//         },
//         init: function () {
//           this.bindUiActions();
//         },
...
//             e.preventDefault();
//           }),
//             e(".checkout").click(function () {
//               e(this).hasClass("preorder-btn") &&
//                 e(window).trigger("fillField"),
//                 t.validateForm(e(this));
//             }),
//             e("input.required").focus(function () {
//               var t = e(this);
//               t.removeClass("error");
//             });
//         },
...
//           var r = !0,
//             i = n.closest("form");
//           e("input.required", i).each(function () {
//             var t = e(this),
//               n =
//                 /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
//             if (e(this).attr("name") === "mail_field") {
//               if (t === "" || !n.test(t.val())) r = !1;
//             } else t === "" && (r = !1);
//           }),
//             r
//               ? t.sendForm(i)
//               : i.parent().hasClass("products-form-block")
//               ? n.velocity("callout.shake", 500)
//               : t.bindPopup(t.data.error);
//         },
//         sendForm: function (n) {
//           var r = "sendmail.php";
//           return (
...
//                   e(".required", n).val("");
//                 }),
//                   e(".products-form").trigger("sent");
//                 var r = function () {
//                   e(".form-popup-block").bPopup().close();
//                 };
//                 n.parent().hasClass("products-form-block")
//                   ? e(window).trigger("orderSent")
//                   : t.bindPopup(t.data.succes);
//               },
//             }),
//             !1
//           );
...
//           e.bPopup({ closeClass: "close-popup", onOpen: t });
//         },
//       };
//       t.init();
//     }
...
//     ["jquery", "velocity", "velocityUi"],
//     function (e) {
//       var t = {
//         select: {
//           dropdown: e(".select"),
//           options: e(".options-list"),
//           container: e(".products-category-list"),
//         },
//         init: function () {
//           this.bindUiActions();
//         },
...
//             var n = e(this);
//             e("dt a", n).click(function (e) {
//               e.preventDefault(), t.toggleOpen(n);
//             }),
//               e("dd .options-list li a", n).click(function (r) {
//                 r.preventDefault();
//                 var i = e(this).html(),
//                   s = e(this);
//                 t.setValue(s, i, n);
//               }),
//               e(document).bind("click", function (n) {
//                 var r = e(n.target);
//                 t.closeDropdown(r);
//               }),
//               e(".close-btn", t.select.options).click(function () {
//                 t.closeDropdown();
//               });
//           });
//         },
//         closeDropdown: function (n) {
//           e(".category-list", t.select.container).hasClass("changing") ||
//             (n
//               ? n.parents().hasClass("select") ||
//                 t.select.container.each(function () {
//                   t.select.container.removeClass("active");
//                 })
//               : t.select.container.each(function () {
//                   t.select.container.removeClass("active");
//                 }));
//         },
//         toggleOpen: function () {
//           t.select.container.hasClass("active")
//             ? t.select.container.removeClass("active")
//             : (t.select.container.each(function () {
//                 t.select.container.removeClass("active");
//               }),
//               t.select.container.addClass("active"),
//               e(".category-item")
//                 .css("opacity", "0")
...
//           var i = e("span.value", t).html();
//           e("dt a span", r).html(n),
//             e("input", r).length && e("input", r).val(i);
//         },
//       };
//       t.init();
//     }
//   ),
//   define("components/mapStyles", [], function () {
//     var e = [
//       {
...
//     return e;
//   }),
//   define("components/googleMap", ["components/mapStyles"], function (e) {
//     var t = {
//       init: function () {
//         var t = document.getElementById("map-block"),
//           n = new google.maps.LatLng(40.799645, -73.952437),
//           r = {
//             zoom: 15,
//             center: n,
...
//           s = { url: "images/pin.png" },
//           o = new google.maps.Marker({ position: n, map: i, icon: s });
//       },
//     };
//     t.init();
//   }),
...
//     ["jquery", "owlCarousel", "underscore", "domReady"],
//     function (e, t, n) {
//       var r = {
//         select: { header: e(".header-carousel"), vbg: e(".video-bg-wrapper") },
//         init: function () {
//           this.bindUiActions();
//         },
//         bindUiActions: function () {
//           e(".header-carousel").length &&
//             (r.initHeaderFlex(),
//             e(window).resize(
//               n.debounce(function () {
//                 r.setItemsHeight(), r.resizeHeaderImages();
//               }, 500)
//             )),
//             e(".video-bg-wrapper").length &&
//               (r.setVbgHeight(),
//               r.checkVideoSize(),
//               e(window).resize(
//                 n.debounce(function () {
//                   r.setVbgHeight(), r.checkVideoSize();
//                 }, 500)
//               ));
//         },
//         checkVideoSize: function () {
//           e(".js-video-bg").removeClass("large-video");
//           var t = e(".js-video-bg").height(),
//             n = e(window).innerHeight();
//           t < n && e(".js-video-bg").addClass("large-video");
//         },
//         setVbgHeight: function () {
//           r.select.vbg.height(e(window).innerHeight());
//         },
//         initCarousel: function (e, t) {
//           e.owlCarousel(t);
//         },
...
//             r.createPaginationDummy(),
//               r.setItemsHeight(),
//               r.resizeHeaderImages();
//           });
//           var e = {
...
//             items: 1,
//           };
//           r.initCarousel(this.select.header, e),
//             this.select.header.on("changed.owl.carousel", function () {
//               r.initPagination();
//             });
//         },
//         setItemsHeight: function () {
//           e(".owl-item", r.select.header).css(
//             "height",
//             e(window).innerHeight()
//           );
//         },
//         resizeHeaderImages: function () {
//           e("img", r.select.header).each(function () {
//             e(this).removeClass("absolute-image");
//             var t = e(this).height(),
//               n = r.select.header.height();
//             if (t < n) {
//               e(this).addClass("absolute-image");
//               var i = e(this).width() / 2;
//               e(this).css("margin-left", -i);
//             } else e(this).removeClass("absolute-image").removeAttr("style");
//           });
//         },
//         createPaginationDummy: function () {
//           r.select.header.find(".owl-controls").append('<div class="dummy">'),
//             r.initPagination();
//         },
//         initPagination: function () {
//           var t = e(".owl-dot.active", r.select.header).position().top,
//             n = e(".dummy");
//           t === 0
//             ? n.animate({ top: "-6px" }, 500)
//             : n.animate({ top: t + "px" }, 500),
//             e(".owl-dot", r.select.header).click(function () {
//               if (e(".animated", r.select.header).length) return !1;
//             });
//         },
//       };
//       r.init();
//     }
//   ),
//   define("components/bgVideo", ["jquery", "underscore"], function (e) {
//     var t = {
//       get: {
//         container: e(".js-video-block"),
//         playBtn: e(".js-play-btn"),
//         video: e(".js-page-video"),
//       },
//       init: function () {
//         this.bingUiActions();
//       },
...
//         t.get.playBtn.on("click tap", function (n) {
//           n.preventDefault(),
//             e(this).toggleClass("playing"),
//             e(this).hasClass("playing")
//               ? t.get.video.trigger("play")
//               : t.get.video.trigger("pause");
//         });
//       },
//     };
//     t.init();
//   }),
//   define("components/mobileMenu", ["jquery"], function (e) {
//     var t = {
//       get: {
//         toggleBtn: e(".js-toggle-menu"),
//         navContainer: e(".js-mobile-container"),
//         navList: e(".js-navs-list"),
//       },
//       init: function () {
//         this.bindUiActions();
//       },
//       bindUiActions: function () {
//         t.appendNavsForMobile(),
//           t.get.toggleBtn.click(function () {
//             t.toggleMenu();
//           }),
//           e(".menu-item", t.get.navContainer).click(function () {
//             t.get.toggleBtn.removeClass("is-active"),
//               t.get.navContainer.removeClass("is-active");
//           });
//       },
//       appendNavsForMobile: function () {
//         t.get.navList.clone().appendTo(t.get.navContainer),
//           e(".menu-item", t.get.navContainer).each(function () {
//             e(this).on("click tap", function (t) {
//               t.preventDefault();
//               var n = e("a", e(this)).attr("href"),
//                 r = e(n).offset().top;
...
//       },
//       toggleMenu: function () {
//         e(".menu-item", t.get.navContainer)
//           .css("opacity", "0")
//           .velocity("stop")
//           .velocity("transition.slideDownIn", { stagger: 100 }),
//           t.get.navContainer.toggleClass("is-active"),
//           t.get.toggleBtn.toggleClass("is-active");
//       },
//     };
//     t.init();
//   }),
//   define("components/reveal", ["jquery", "velocity", "inView"], function (e) {
//     var t = {
//         $prod: e(".prod-item"),
//         $team: e(".about-team"),
//         $news: e(".js-news-item"),
...
//           t.$footer.each(function (t) {
//             e(this).one("inview", function () {
//               e(this).velocity(
//                 { opacity: "1", translateY: ["0", "30px"] },
//                 { duration: 1e3, delay: t * 100 }
//               );
//             });
//           });
//         },
//         revealList: function () {
//           e(".stats-in-number").one("inview", function () {
//             t.$stats.velocity("transition.bounceIn", {
//               stagger: 100,
//               delay: 100,
//             });
//           });
...
//         },
//         revealNews: function () {
//           t.$news.each(function (t) {
//             e(this).one("inview", function () {
//               e(this).velocity(
//                 { opacity: "1", translateY: ["0", "50px"] },
//                 { duration: 1e3, delay: t * 150 }
//               );
//             });
//           });
//         },
//         revealTeam: function () {
//           t.$team.each(function (t) {
//             e(this).one("inview", function () {
//               e(this).velocity(
//                 { opacity: "1", translateY: ["0", "50px"] },
//                 { duration: 1e3, delay: t * 150 }
...
//       var i = {
//         get: {
//           container: n(".preloader-container"),
//           imgBox: n(".img-box"),
//           image: n(".preloader-block img"),
//         },
//         init: function () {
//           this.bindUiActions();
//         },
//         bindUiActions: function () {
//           n(".color-wave").length && i.createCanvasPreloader(),
//             e(function () {
//               n("html, body").stop().animate({ scrollTop: 0 }),
//                 i.closePreloader();
//             }),
//             i.get.container.waitForImages(function () {
//               i.prepareElementsForEnter();
//             });
//         },
//         closePreloader: function () {
//           n(window).trigger("Reveal"),
//             n(".js-video-bg").trigger("play"),
//             i.get.container
//               .parent()
//               .velocity({ translateX: "100%" }, 700, function () {
//                 n(".preloader-block").remove(), i.enterElements();
//               });
//         },
//         prepareElementsForEnter: function () {
//           n(".menu-item").css("opacity", "0"),
//             n(".js-slidedown-reveal").css("opacity", "0");
//         },
//         enterElements: function () {
//           setTimeout(function () {
//             n(".js-slidedown-reveal").velocity("transition.slideDownIn", {
//               duration: 1e3,
//               stagger: 1e3,
//             });
//           }, 1e3),
//             n(".menu-item").velocity("transition.slideDownBigIn", {
//               duration: 500,
//               stagger: 150,
//             });
//         },
...
//             t = e.getContext("2d"),
//             r = (e.width = i.get.image.outerWidth()),
//             s = (e.height = i.get.image.outerHeight() * 2),
//             o = [],
//             u = 0,
//             a = {
//               count: 5,
...
//                 : (-n / 2) * (--e * (e - 2) - 1) + t;
//             };
//           i.get.image.width(r + 2).height(s / 2),
//             n(".color-wave")
//               .width(r)
//               .height(s / 2),
//             (t.lineJoin = "round"),
//             (t.lineWidth = a.thickness),
//             (t.strokeStyle = a.strokeColor);
//           var c = function (e) {
//             (this.anchorX = e.x),
//               (this.anchorY = e.y),
//               (this.x = e.x),
...
//               (this.targetX = this.anchorX + f(0, a.range.x * 2) - a.range.x),
//               (this.targetY = this.anchorY + f(0, a.range.y * 2) - a.range.y),
//               (this.tick = 0),
//               (this.duration = f(a.duration.min, a.duration.max));
//           }),
...
//               t.beginPath(),
//                 t.arc(this.x, this.y, 3, 0, Math.PI * 2, !1),
//                 (t.fillStyle = "#000"),
//                 t.fill();
//             });
//           var h = function () {
...
//               var n;
//               for (n = 0; n < e - 1; n++) {
//                 var i = (o[n].x + o[n + 1].x) / 2,
//                   f = (o[n].y + o[n + 1].y) / 2;
//                 t.quadraticCurveTo(o[n].x, o[n].y, i, f);
//               }
//               t.lineTo(-a.range.x - a.thickness, s + a.thickness),
//                 t.lineTo(r + a.range.x + a.thickness, s + a.thickness),
//                 t.closePath(),
//                 (t.fillStyle = "hsl(" + u / 2 + ", 70%, 60%)"),
//                 t.fill();
//             },
//             v = function () {
//               t.clearRect(0, 0, r, s);
//             },
//             m = function () {
//               window.requestAnimFrame(m, e), u++, v(), h(), d();
//             },
//             g = a.count + 2,
//             y = (r + a.range.x * 2) / (a.count - 1);
//           while (g--)
//             o.push(new c({ x: y * (g - 1) - a.range.x, y: s - s * a.level }));
...
//           r = n[0].split("-"),
//           i = n[1].split(":");
//         return new Date(r[0], r[1] - 1, r[2], i[0], i[1], i[2]);
//       }
//       var s = Date.parse(e);
//       return isNaN(s)
//         ? ((s = Date.parse(e.replace(/-/g, "/").replace("T", " "))),
//           isNaN(s) ? new Date() : s)
//         : s;
//     }
...
//         var d = r[p],
//           v;
//         h === null ? (v = n / a[d]) : (v = a[h] / a[d]);
//         var m = e / a[d],
//           g = t / a[d];
//         i &&
//           (m > 0 ? (m = Math.floor(m)) : (m = Math.ceil(m)),
//           g > 0 ? (g = Math.floor(g)) : (g = Math.ceil(g))),
//           d !== "Days" && ((m %= v), (g %= v)),
//           (s[d] = m),
//           (u[d] = Math.abs(m)),
//           (o[d] = g),
...
//     }
//     function m() {
//       typeof t.TC_Instance_List != "undefined"
//         ? (v = t.TC_Instance_List)
//         : (t.TC_Instance_List = v),
//         g(t);
//     }
//     function g(e) {
//       var t = ["webkit", "moz"];
//       for (var n = 0; n < t.length && !e.requestAnimationFrame; ++n)
//         (e.requestAnimationFrame = e[t[n] + "RequestAnimationFrame"]),
//           (e.cancelAnimationFrame = e[t[n] + "CancelAnimationFrame"]);
//       if (!e.requestAnimationFrame || !e.cancelAnimationFrame)
//         (e.requestAnimationFrame = function (t, n, r) {
//           typeof r == "undefined" && (r = { data: { last_frame: 0 } });
//           var i = new Date().getTime(),
//             s = Math.max(0, 16 - (i - r.data.last_frame)),
//             o = e.setTimeout(function () {
//               t(i + s);
//             }, s);
//           return (r.data.last_frame = i + s), o;
//         }),
...
//     }),
//       (y.prototype.addTime = function (e) {
//         if (this.data.attributes.ref_date instanceof Date) {
//           var t = this.data.attributes.ref_date;
//           t.setSeconds(t.getSeconds() + e);
//         } else
//           isNaN(this.data.attributes.ref_date) ||
//             (this.data.attributes.ref_date += e * 1e3);
//       }),
//       (y.prototype.initialize = function (r) {
//         this.data.drawn_units = [];
//         for (var i = 0; i < Object.keys(this.config.time).length; i++) {
//           var s = Object.keys(this.config.time)[i];
//           this.config.time[s].show && this.data.drawn_units.push(s);
//         }
//         e(this.element).children("div.time_circles").remove(),
//           typeof r == "undefined" && (r = !0),
//           (r || this.listeners === null) && this.clearListeners(),
//           (this.container = e("<div>")),
//           this.container.addClass("time_circles"),
//           this.container.appendTo(this.element);
//         var o = this.element.offsetHeight,
//           u = this.element.offsetWidth;
//         o === 0 && (o = e(this.element).height()),
//           u === 0 && (u = e(this.element).width()),
//           o === 0 && u > 0
//             ? (o = u / this.data.drawn_units.length)
//             : u === 0 && o > 0 && (u = o * this.data.drawn_units.length);
//         var a = document.createElement("canvas");
//         (a.width = u),
//           (a.height = o),
//           (this.data.attributes.canvas = e(a)),
//           this.data.attributes.canvas.appendTo(this.container);
//         var f = l();
//         !f &&
//           typeof G_vmlCanvasManager != "undefined" &&
//           (G_vmlCanvasManager.initElement(a), (n = !0), (f = !0)),
//           f && (this.data.attributes.context = a.getContext("2d")),
//           (this.data.attributes.item_size = Math.min(
//             u / this.data.drawn_units.length,
//             o
//           )),
//           (this.data.attributes.line_width =
//             this.data.attributes.item_size * this.config.fg_width),
//           (this.data.attributes.radius =
//             (this.data.attributes.item_size * 0.8 -
//               this.data.attributes.line_width) /
//             2),
...
//               ));
//         var i = 0;
//         for (var c in this.data.text_elements) {
//           if (!this.config.time[c].show) continue;
//           var h = e("<div>");
//           h.addClass("textDiv_" + c),
...
//           var p = e("<h4>");
//           p.text(this.config.time[c].text),
//             p.css(
//               "font-size",
...
//             ),
//             d.appendTo(h),
//             (this.data.text_elements[c] = d);
//         }
//         this.start(), this.config.start || (this.data.paused = !0);
//         var v = this;
//         this.data.interval_fallback = t.setInterval(function () {
//           v.update.call(v, !0);
//         }, 100);
//       }),
...
//         var i,
//           s,
//           u = this.data.prev_time,
//           f = new Date();
//         (this.data.prev_time = f), u === null && (u = f);
//         if (!this.config.count_past_zero && f > this.data.attributes.ref_date) {
//           for (var l = 0; l < this.data.drawn_units.length; l++) {
//             var c = this.data.drawn_units[l];
//             this.data.text_elements[c].text("0");
//             var h =
//                 l * this.data.attributes.item_size +
//                 this.data.attributes.item_size / 2,
//               p = this.data.attributes.item_size / 2,
//               v = this.config.time[c].color;
//             this.drawArc(h, p, v, 0);
//           }
//           this.stop();
//           return;
//         }
//         (i = (this.data.attributes.ref_date - f) / 1e3),
//           (s = (this.data.attributes.ref_date - u) / 1e3);
//         var m = this.config.animation !== "smooth",
//           g = d(i, s, this.data.total_duration, this.data.drawn_units, m),
//           y = d(i, s, a.Years, o, m),
//           l = 0,
//           b = 0,
//           w = null,
//           E = this.data.drawn_units.slice();
//         for (var l in o) {
//           var c = o[l];
//           Math.floor(y.raw_time[c]) !== Math.floor(y.raw_old_time[c]) &&
...
//           Math.floor(g.raw_time[c]) !== Math.floor(g.raw_old_time[c]) &&
//             this.notifyListeners(
//               c,
//               Math.floor(g.time[c]),
//               Math.floor(i),
...
//             );
//           if (!e) {
//             this.data.text_elements[c].text(Math.floor(Math.abs(g.time[c])));
//             var h =
//                 b * this.data.attributes.item_size +
//                 this.data.attributes.item_size / 2,
//               p = this.data.attributes.item_size / 2,
//               v = this.config.time[c].color;
//             this.config.animation === "smooth"
//               ? (w !== null &&
//                   !n &&
//                   (Math.floor(g.time[w]) > Math.floor(g.old_time[w])
//                     ? (this.radialFade(h, p, v, 1, c),
//                       (this.data.state.fading[c] = !0))
//                     : Math.floor(g.time[w]) < Math.floor(g.old_time[w]) &&
//                       (this.radialFade(h, p, v, 0, c),
//                       (this.data.state.fading[c] = !0))),
//                 this.data.state.fading[c] || this.drawArc(h, p, v, g.pct[c]))
//               : this.animateArc(
//                   h,
//                   p,
//                   v,
...
//           (w = c), b++;
//         }
//         if (this.data.paused || e) return;
//         var S = this,
//           x = function () {
//             S.update.call(S);
//           };
//         if (this.config.animation === "smooth")
//           this.data.animation_frame = t.requestAnimationFrame(x, S.element, S);
//         else {
//           var T = (i % 1) * 1e3;
//           T < 0 && (T = 1e3 + T),
//             (T += 50),
//             (S.data.animation_frame = t.setTimeout(function () {
//               S.data.animation_frame = t.requestAnimationFrame(x, S.element, S);
//             }, T));
//         }
//       }),
//       (y.prototype.animateArc = function (e, n, i, s, o, u) {
//         if (this.data.attributes.context === null) return;
//         var a = o - s;
//         if (Math.abs(a) > 0.5)
//           s === 0 ? this.radialFade(e, n, i, 1) : this.radialFade(e, n, i, 0);
//         else {
//           var f = (r - (u - new Date().getTime())) / r;
//           f > 1 && (f = 1);
//           var l = o * (1 - f) + s * f;
//           this.drawArc(e, n, i, l);
//           if (f >= 1) return;
//           var c = this;
//           t.requestAnimationFrame(function () {
//             c.animateArc(e, n, i, s, o, u);
//           }, this.element);
//         }
//       }),
//       (y.prototype.drawArc = function (e, t, r, i) {
//         if (this.data.attributes.context === null) return;
//         var s = Math.max(
//           this.data.attributes.outer_radius,
//           this.data.attributes.item_size / 2
//         );
//         n || this.data.attributes.context.clearRect(e - s, t - s, s * 2, s * 2),
...
//           f = -0.5 * Math.PI,
//           l = 2 * Math.PI;
//         o = f + (this.config.start_angle / 360) * l;
//         var c = 2 * i * Math.PI;
//         this.config.direction === "Both"
//           ? ((a = !1), (o -= c / 2), (u = o + c))
//           : this.config.direction === "Clockwise"
//           ? ((a = !1), (u = o + c))
//           : ((a = !0), (u = o - c)),
//           this.data.attributes.context.beginPath(),
//           this.data.attributes.context.arc(
...
//           (this.data.attributes.context.lineWidth =
//             this.data.attributes.line_width),
//           (this.data.attributes.context.strokeStyle = r),
//           this.data.attributes.context.stroke();
//       }),
//       (y.prototype.radialFade = function (e, n, r, i, s) {
//         var o = f(r),
//           u = this,
//           a = 0.2 * (i === 1 ? -1 : 1),
//           l;
...
//         typeof s !== undefined &&
//           t.setTimeout(function () {
//             u.data.state.fading[s] = !1;
//           }, 50 * l);
//       }),
//       (y.prototype.timeLeft = function () {
...
//         t.cancelAnimationFrame(this.data.animation_frame),
//           t.clearTimeout(this.data.animation_frame);
//         var n = e(this.element).data("date");
//         typeof n == "undefined" && (n = e(this.element).attr("data-date"));
//         if (typeof n == "string") this.data.attributes.ref_date = p(n);
//         else if (typeof this.data.timer == "number")
//           this.data.paused &&
//             (this.data.attributes.ref_date =
//               new Date().getTime() + this.data.timer * 1e3);
//         else {
//           var r = e(this.element).data("timer");
//           typeof r == "undefined" && (r = e(this.element).attr("data-timer")),
...
//         this.clearListeners(),
//           this.stop(),
//           t.clearInterval(this.data.interval_fallback),
//           (this.data.interval_fallback = null),
//           this.container.remove(),
//           e(this.element).removeAttr("data-tc-id"),
//           e(this.element).removeData("tc-id");
//       }),
//       (y.prototype.setOptions = function (n) {
//         this.config === null &&
//           ((this.default_options.ref_date = new Date()),
//           (this.config = e.extend(!0, {}, this.default_options))),
//           e.extend(!0, this.config, n),
//           this.config.use_top_frame ? (t = window.top) : (t = window),
//           m(),
//           (this.data.total_duration = this.config.total_duration);
//         if (typeof this.data.total_duration == "string")
//           if (typeof a[this.data.total_duration] != "undefined")
//             this.data.total_duration = a[this.data.total_duration];
//           else if (this.data.total_duration === "Auto")
//             for (var r = 0; r < Object.keys(this.config.time).length; r++) {
//               var i = Object.keys(this.config.time)[r];
//               if (this.config.time[i].show) {
//                 this.data.total_duration = a[u[i]];
//                 break;
//               }
//             }
//           else
...
//               );
//       }),
//       (y.prototype.addListener = function (e, t, n) {
//         if (typeof e != "function") return;
//         typeof n == "undefined" && (n = "visible"),
//           this.listeners[n].push({ func: e, scope: t });
//       }),
//       (y.prototype.notifyListeners = function (e, t, n, r) {
//         for (var i = 0; i < this.listeners[r].length; i++) {
//           var s = this.listeners[r][i];
//           s.func.apply(s.scope, [e, t, n]);
//         }
//       }),
//       (y.prototype.default_options = {
//         ref_date: new Date(),
//         start: !0,
//         animation: "smooth",
//         count_past_zero: !0,
...
//       var n,
//         r = e(t).data("tc-id");
//       typeof r == "undefined" && ((r = h()), e(t).attr("data-tc-id", r));
//       if (typeof v[r] == "undefined") {
//         var i = this.options,
//           s = e(t).data("options");
//         typeof s == "string" && (s = JSON.parse(s)),
//           typeof s == "object" && (i = e.extend(!0, {}, this.options, s)),
//           (n = new y(t, i)),
//           (v[r] = n);
//       } else
//         (n = v[r]),
//           typeof this.options != "undefined" && n.setOptions(this.options);
//       return n;
//     }),
//       (b.prototype.addTime = function (e) {
...
//       });
//   })(jQuery),
//   define("circleTimer", function () {}),
//   define(
//     "components/timer",
//     ["jquery", "underscore", "circleTimer"],
//     function (e, t) {
//       var n = {
//           timer: e(".countdown-block"),
//           color: e(".theme-bg-c")
...
//         r = {
//           init: function () {
//             this.getThemeColor(), this.initTimer();
//           },
...
//               time: {
//                 Days: { text: "Days", color: n.timeColor, show: !0 },
//                 Hours: { text: "Hours", color: n.timeColor, show: !0 },
//                 Minutes: { text: "Minutes", color: n.timeColor, show: !0 },
//                 Seconds: { text: "Seconds", color: n.timeColor, show: !0 },
//               },
//             }),
//               e(window).resize(
//                 t.debounce(function () {
//                   n.timer.TimeCircles().rebuild();
//                 }, 500)
//               );
//           },
//         };
...
//     }
//   ),
//   define("products/categories/bags", [], function () {
//     return {
//       name: "Bags",
//       oneRow: !1,
...
//     };
//   }),
//   define("products/categories/jeans", [], function () {
//     return {
//       name: "Jeans",
//       oneRow: !1,
//       imagesPath: "http://placehold.it/",
...
//       items: [
//         {
//           name: "New Look Jeans In Super Skinny Fit",
//           price: { current: "118.00" },
//           code: "N8201",
//           details:
//             "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptates odit vitae repellat doloremque dolorem, numquam.",
//           thumb: "290x370",
...
//         },
//         {
//           name: "Esprit Straight Fit Jean In Light Stone Wash",
//           price: { current: "105.30", old: "108.00" },
//           code: "N8202",
//           details:
//             "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi, animi quam obcaecati.",
//           thumb: "290x370",
...
//         },
//         {
//           name: "New Look Jeans in Skinny Fit",
//           price: { current: "98.00" },
//           code: "N8203",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370",
...
//         },
//         {
//           name: "Esprit Straight Jeans With Rips",
//           price: { current: "95.00" },
//           code: "N8204",
//           details:
//             "Lorem ipsum dolor sit amet, consectetur adipisicing. Voluptates odit vitae repellat doloremque dolorem, numquam.",
//           thumb: "290x370",
//           gallery: ["460x590", "460x590", "460x590"],
//         },
//         {
//           name: "Solid Acid Wash Jeans In Skinny Fit",
//           price: { current: "55.30", old: "79.00" },
//           code: "N8205",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370",
//           gallery: ["460x590", "460x590", "460x590"],
//         },
//         {
//           name: "WeSC Peter Drop Crotch Jeans",
//           price: { current: "58.00" },
//           code: "N8206",
//           details:
//             "Lorem ipsum dolor sit amet, consectetur adipisicing. Voluptates odit vitae repellat doloremque dolorem, numquam.",
...
//         },
//         {
//           name: "Carhartt Rebel Slim Jeans",
//           price: { current: "87.30", old: "93.00" },
//           code: "N8207",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370",
//           gallery: ["460x590", "460x590", "460x590"],
...
//     };
//   }),
//   define("products/categories/shirts", [], function () {
//     return {
//       name: "Shirts",
//       oneRow: !1,
//       imagesPath: "http://placehold.it/",
...
//       items: [
//         {
//           name: "Shirt In Long Sleeve With Grey Marl Check",
//           price: { current: "35.00" },
//           code: "N8401",
//           details:
//             "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptates odit vitae repellat doloremque dolorem, numquam.",
...
//         },
//         {
//           name: "Selected Window Pane Check Shirt",
//           price: { current: "35.30", old: "38.00" },
//           code: "N8402",
//           details:
//             "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi, animi quam obcaecati.",
//           thumb: "290x370",
...
//         },
//         {
//           name: "Selected Flannel Check Shirt",
//           price: { current: "48.00", old: "53.00" },
//           code: "N8403",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370",
//           gallery: ["460x590", "460x590", "460x590"],
//         },
//         {
//           name: "Universal Works Shirt with Ikat",
//           price: { current: "138.00" },
//           code: "N8404",
//           details:
//             "Lorem ipsum dolor sit amet, consectetur adipisicing. Voluptates odit vitae repellat doloremque dolorem, numquam.",
//           thumb: "290x370",
...
//         },
//         {
//           name: "Blood Brother All Over Printed Shirt",
//           price: { current: "85.30", old: "98.00" },
//           code: "N8405",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370",
//           gallery: ["460x590", "460x590", "460x590"],
//         },
//         {
//           name: "YMC Flannel Shirt with Button Down Collar",
...
//         },
//         {
//           name: "Reiss Formal Shirt In Slim Fit",
//           price: { current: "112.00", old: "105.30" },
//           code: "N8407",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370",
//           gallery: ["460x590", "460x590", "460x590"],
...
//         },
//         {
//           name: "Solid Shirt With Geometric Print",
//           price: { current: "56.00", old: "105.30" },
//           code: "N8407",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370",
//           gallery: ["460x590", "460x590", "460x590"],
//         },
//         {
//           name: "Afends The Abyss Printed Shirt",
//           price: { current: "78.00" },
//           code: "N8407",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370",
...
//     };
//   }),
//   define("products/categories/shoes", [], function () {
//     return {
//       name: "Shoes",
//       oneRow: !1,
//       imagesPath: "http://placehold.it/",
...
//           price: { current: "85.00", old: "105.30" },
//           code: "N8507",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370",
//           gallery: ["460x590", "460x590", "460x590"],
...
//           price: { current: "169.30", old: "177.00" },
//           code: "N8507",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370",
//           gallery: ["460x590", "460x590", "460x590"],
...
//     };
//   }),
//   define("products/categories/shorts", [], function () {
//     return {
//       name: "Shorts",
//       oneRow: !0,
//       imagesPath: "http://placehold.it/",
...
//       items: [
//         {
//           name: "Denim Short In Slim Mid Length",
//           price: { current: "31.00" },
//           code: "N8601",
//           details:
//             "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptates odit vitae repellat doloremque dolorem, numquam.",
//           thumb: "290x370.jpg",
//           gallery: ["460x590.jpg", "460x590.jpg", "460x590.jpg"],
//         },
//         {
//           name: "Denim Shorts In Longer Length",
//           price: { current: "30.00", old: "39.00" },
//           code: "N8602",
//           details:
//             "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi, animi quam obcaecati.",
//           thumb: "290x370.jpg",
...
//         },
//         {
//           name: "River Island Shorts With Print",
//           price: { current: "39.00" },
//           code: "N8603",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370.jpg",
...
//         },
//         {
//           name: "Chino Shorts In Mid Length",
//           price: { current: "23.00", old: "28.00" },
//           code: "N8604",
//           details:
//             "Lorem ipsum dolor sit amet, consectetur adipisicing. Voluptates odit vitae repellat doloremque dolorem, numquam.",
//           thumb: "290x370.jpg",
...
//         },
//         {
//           name: "Siksilk Mini Shorts in Polka Dot",
//           price: { current: "47.30", old: "49.00" },
//           code: "N8605",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370.jpg",
//           gallery: ["460x590.jpg", "460x590.jpg", "460x590.jpg"],
...
//         },
//         {
//           name: "Bellfield Twisted Chino Short",
//           price: { current: "27.30" },
//           code: "N8607",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370.jpg",
...
//     };
//   }),
//   define("products/categories/t-shirts", [], function () {
//     return {
//       name: "T-shirts",
//       oneRow: !1,
//       imagesPath: "http://placehold.it/",
...
//       items: [
//         {
//           name: "Jack & Jones T-Shirt With Chest Embroidery",
//           price: { current: "15.00", old: "17.00" },
//           code: "N8701",
//           details:
//             "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptates odit vitae repellat doloremque dolorem, numquam.",
//           thumb: "290x370.jpg",
...
//         },
//         {
//           name: "3/4 Sleeve T-Shirt With Notch Neck",
//           price: { current: "17.50", old: "19.00" },
//           code: "N8702",
//           details:
//             "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi, animi quam obcaecati.",
//           thumb: "290x370.jpg",
...
//         },
//         {
//           name: "Diesel T-Shirt T-Elist 3D Logo Print",
//           price: { current: "49.00" },
//           code: "N8703",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370.jpg",
...
//         },
//         {
//           name: "Jack & Jones T-Shirt With Coffin & Skull Print",
//           price: { current: "11.30", old: "19.00" },
//           code: "N8704",
//           details:
//             "Lorem ipsum dolor sit amet, consectetur adipisicing. Voluptates odit vitae repellat doloremque dolorem, numquam.",
//           thumb: "290x370.jpg",
...
//         },
//         {
//           name: "Majestic New York Jets Classic Coach T-Shirt",
//           price: { current: "35.00" },
//           code: "N8705",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370.jpg",
...
//         },
//         {
//           name: "Bellfield T-Shirt With Jacquard Pocket",
//           price: { current: "25.00" },
//           code: "N8706",
//           details:
//             "Lorem ipsum dolor sit amet, consectetur adipisicing. Voluptates odit vitae repellat doloremque dolorem, numquam.",
...
//         },
//         {
//           name: "Criminal Damage T-Shirt In Choc Print",
//           price: { current: "42.30" },
//           code: "N8707",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370.jpg",
...
//         },
//         {
//           name: "Stussy 80 Football Crew Long Sleeve T-Shirt",
//           price: { current: "99.00" },
//           code: "N8707",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370.jpg",
...
//         },
//         {
//           name: "Esprit T-Shirt With Crowd Print",
//           price: { current: "21.00" },
//           code: "N8707",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370.jpg",
...
//         },
//         {
//           name: "T-Shirt With Tape Trim Pocket",
//           price: { current: "19.00" },
//           code: "N8707",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370.jpg",
...
//         },
//         {
//           name: "T-Shirt With Striped Cut And Sew Panels",
//           price: { current: "25.00" },
//           code: "N8707",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370.jpg",
...
//         },
//         {
//           name: "T-Shirt With Aztec Jacquard",
//           price: { current: "38.00" },
//           code: "N8707",
//           details: "Lorem ipsum dolor sit amet, consectetur adipisicing.",
//           thumb: "290x370.jpg",
...
//       url: function () {
//         var e =
//           n.result(this, "urlRoot") || n.result(this.collection, "url") || F();
//         return this.isNew()
//           ? e
...
//             a instanceof d
//               ? (o = u = a)
//               : (o = a[h.prototype.idAttribute || "id"]);
//           if ((f = this.get(o)))
//             S && (b[f.cid] = !0),
//               E &&
...
//     return t;
//   }),
//   define("products/models/categoryModel", ["backbone"], function () {
...
//     ["products/models/categoryModel", "jquery", "backbone", "underscore"],
//     function (e) {
//       var t = Backbone.Collection.extend({ model: e });
//       return t;
//     }
//   ),
//   define("products/views/categoryListView", ["backbone"], function () {
...
//           var n = _.extend(t.toJSON(), { cid: t.cid });
//           e.$el.append(e.template(n));
//         }),
//           $(".js-category-item", e.$el).click(function () {
//             $(window).trigger("loadNewCategory", $(this).data("target"));
//           }),
//           $(".currency", e.$el).html($("body").data("currency"));
//       },
//       render: function () {
//         return this;
//       },
...
//     return e;
//   }),
//   define("products/views/itemView", ["backbone"], function (e) {
//     var t = e.View.extend({
//       tagName: "div",
...
//       initialize: function () {
//         var e = this,
//           t = _.extend(e.model.toJSON(), { cid: e.model.cid });
//         e.$el.append(e.template(t)),
//           $(".js-view-product", e.$el).click(function () {
//             $(window).trigger("showProductItem", $(this).data("target"));
//           }),
//           $(".add-product-code", e.$el).click(function () {
//             $(window).trigger("addToCart", $(this).data("target"));
//             var e = $('<div class="plusOne">+1</div>');
//             e.appendTo($(this)),
//               setTimeout(function () {
//                 $(e, $(this)).remove();
//               }, 1e3);
...
//     return t;
//   }),
//   define("products/models/itemModel", ["backbone"], function () {
//     var e = Backbone.Model.extend({
//       defaults: {
//         name: "",
//         price: { current: "", old: "" },
...
//     ["backbone", "products/views/itemView", "products/models/itemModel"],
//     function (e, t, n) {
//       var r = e.View.extend({
//         tagName: "div",
//         className: "products-slider js-products-slider",
//         template: _.template(['<ul class="slides"></ul>'].join("")),
//         initialize: function () {
//           var e = this,
//             r = [];
//           e.$el.attr("data-target", e.model.cid).append(e.template()),
//             e.model.get("items").forEach(function (i) {
//               var s = new n();
//               s.set(i);
//               if (e.model.get("addCodePath"))
//                 var o = e.model.get("imagesPath") + i.code + "/";
//               else var o = e.model.get("imagesPath");
//               s.set({ path: o }), window.ItemsCollection.add(s);
//               var u = new t({ model: s });
//               r.push(u.render().el);
//             }),
//             e.model.get("oneRow")
//               ? (e.$el.find(".slides").append(r),
//                 e.$el.find(".prod-item").wrap("<li></li>"))
//               : e.wrapElements(r),
//             $(".currency", e.$el).html($("body").data("currency"));
//         },
//         wrapElements: function (e) {
//           var t = "",
//             n = this,
//             r = e.length;
//           $.each(e, function (e, i) {
//             e % 2 === 0
//               ? ((t = $("<li>")), t.append(i))
//               : (t.append(i), n.$el.find(".slides").append(t)),
//               e === r - 1 && r % 2 !== 0 && n.$el.find(".slides").append(t);
//           });
//         },
//         render: function () {
//           return this;
...
//     ["products/models/itemModel", "backbone", "underscore"],
//     function (e) {
//       var t = Backbone.Collection.extend({ model: e });
//       return t;
//     }
//   ),
//   define("products/models/formModel", ["backbone"], function () {
//     var e = Backbone.Model.extend({
//       defaults: { name: "", price: "", parent: "", code: "" },
//     });
//     return e;
//   }),
//   define(
//     "products/collection/formCollection",
//     ["products/models/formModel", "backbone"],
//     function (e) {
//       var t = Backbone.Collection.extend({ model: e });
//       return t;
//     }
...
//                   }, 1e3);
//                 var t = $(".added", $(this));
//                 t.velocity({ translateY: ["0", "-100%"] }, 250, function () {
//                   t.velocity(
//                     { translateY: ["100%", "0"] },
...
//     ["backbone", "underscore", "velocity", "velocityUi"],
//     function () {
//       var e = Backbone.View.extend({
//         tagName: "ul",
...
//             e.$el.append(e.template(n));
//           }),
//             $(".js-remove-prod", e.$el).click(function () {
//               e.collection.remove(
//                 e.collection.get({ cid: $(this).data("selfid") })
//               );
//               var t = $(this).closest(".js-order-item");
//               t.velocity("transition.slideRightBigOut", 400, function () {
//                 t.remove();
//               });
//             }),
//             $(".js-order-item", e.$el).each(function () {
//               var e = $(".js-order-price .value", $(this)).html();
//               $(".js-order-price .value", $(this)).html(
...
//         (f = 0 === p ? h : p),
//         "deltaY" in o && ((p = -1 * o.deltaY), (f = p)),
//         "deltaX" in o && ((h = o.deltaX), 0 === p && (f = -1 * h)),
//         0 !== p || 0 !== h)
//       ) {
//         if (1 === o.deltaMode) {
...
//         }
//         if (
//           ((v = Math.max(Math.abs(p), Math.abs(h))),
//           (!s || s > v) && ((s = v), r(o, v) && (s /= 40)),
//           r(o, v) && ((f /= 40), (h /= 40), (p /= 40)),
...
//         f = {},
//         l = function (e) {
//           f[e] && (clearTimeout(f[e]), d._delete.call(null, f[e]));
//         },
//         c = e.attachEvent && !e.addEventListener ? 1 : 0,
//         h = !1,
//         p = {
//           init: function (e) {
//             var e = n.extend(!0, {}, o, e),
//               t = d._selector.call(this);
//             if (e.live) {
//               var r = e.liveSelector || this.selector || s,
//                 a = n(r);
//               if (e.live === "off") {
//                 l(r);
//                 return;
...
//                 a.mCustomScrollbar(e), e.live === "once" && a.length && l(r);
//               }, 500);
//             } else l(r);
//             return (
//               (e.setWidth = e.set_width ? e.set_width : e.setWidth),
//               (e.setHeight = e.set_height ? e.set_height : e.setHeight),
//               (e.axis = e.horizontalScroll
//                 ? "x"
//                 : d._findAxis.call(null, e.axis)),
//               (e.scrollInertia = e.scrollInertia < 17 ? 17 : e.scrollInertia),
//               typeof e.mouseWheel != "object" &&
//                 e.mouseWheel == 1 &&
//                 (e.mouseWheel = {
//                   enable: !0,
//                   scrollAmount: "auto",
...
//               (e.scrollButtons.scrollType = d._findScrollButtonsType.call(
//                 null,
//                 e.scrollButtons.scrollType
//               )),
//               d._theme.call(null, e),
//               n(t).each(function () {
//                 var t = n(this);
//                 if (!t.data(i)) {
//                   t.data(i, {
...
//                     a = t.data("mcs-theme");
//                   s && (r.axis = s),
//                     o && (r.scrollbarPosition = o),
//                     a && ((r.theme = a), d._theme.call(null, r)),
//                     d._pluginMarkup.call(this),
//                     p.update.call(null, t);
//                 }
//               })
//             );
//           },
//           update: function (e) {
//             var t = e || d._selector.call(this);
...
//                   o = [
//                     n("#mCSB_" + t.idx + "_dragger_vertical"),
//                     n("#mCSB_" + t.idx + "_dragger_horizontal"),
//                   ];
//                 if (!s.length) return;
//                 t.tweenRunning && d._stop.call(null, e),
//                   e.hasClass("mCS_disabled") && e.removeClass("mCS_disabled"),
//                   e.hasClass("mCS_destroyed") && e.removeClass("mCS_destroyed"),
//                   d._maxHeight.call(this),
//                   d._expandContentHorizontally.call(this),
//                   r.axis !== "y" &&
//                     !r.advanced.autoExpandHorizontalScroll &&
//                     s.css("width", d._contentWidth(s.children())),
//                   (t.overflowed = d._overflowed.call(this)),
//                   d._scrollbarVisibility.call(this),
//                   r.autoDraggerLength && d._setDraggerLength.call(this),
//                   d._scrollRatio.call(this),
//                   d._bindEvents.call(this);
//                 var u = [Math.abs(s[0].offsetTop), Math.abs(s[0].offsetLeft)];
//                 r.axis !== "x" &&
//                   (t.overflowed[0]
//                     ? o[0].height() > o[0].parent().height()
//                       ? d._resetContentPosition.call(this)
//                       : d._scrollTo.call(this, e, u[0].toString(), {
//                           dir: "y",
//                           dur: 0,
//                           overwrite: "none",
//                         })
//                     : (d._resetContentPosition.call(this),
//                       r.axis === "y"
//                         ? d._unbindEvents.call(this)
//                         : r.axis === "yx" &&
//                           t.overflowed[1] &&
//                           d._scrollTo.call(this, e, u[1].toString(), {
//                             dir: "x",
//                             dur: 0,
//                             overwrite: "none",
//                           }))),
...
//                   },
//                   a = n.extend(!0, {}, u, t),
//                   f = d._arr.call(this, e),
//                   l = a.scrollInertia < 17 ? 17 : a.scrollInertia;
//                 (f[0] = d._to.call(this, f[0], "y")),
//                   (f[1] = d._to.call(this, f[1], "x")),
//                   a.moveDragger &&
//                     ((f[0] *= s.scrollRatio.y), (f[1] *= s.scrollRatio.x)),
//                   (a.dur = l),
//                   setTimeout(function () {
//                     f[0] !== null &&
//                       typeof f[0] != "undefined" &&
//                       o.axis !== "x" &&
//                       s.overflowed[0] &&
//                       ((a.dir = "y"),
//                       (a.overwrite = "all"),
//                       d._scrollTo.call(this, r, f[0].toString(), a)),
//                       f[1] !== null &&
...
//                         ((a.dir = "x"),
//                         (a.overwrite = "none"),
//                         d._scrollTo.call(this, r, f[1].toString(), a));
//                   }, 60);
//               }
//             });
//           },
...
//               var e = n(this);
//               e.data(i) && d._stop.call(null, e);
//             });
//           },
//           disable: function (e) {
//             var t = d._selector.call(this);
//             return n(t).each(function () {
//               var t = n(this);
//               if (t.data(i)) {
//                 var r = t.data(i),
//                   s = r.opt;
//                 d._autoUpdate.call(this, "remove"),
//                   d._unbindEvents.call(this),
//                   e && d._resetContentPosition.call(this),
//                   d._scrollbarVisibility.call(this, !0),
...
//                   o = s.opt,
//                   u = n("#mCSB_" + s.idx),
//                   a = n("#mCSB_" + s.idx + "_container"),
//                   f = n(".mCSB_" + s.idx + "_scrollbar");
//                 o.live && l(e),
//                   d._autoUpdate.call(this, "remove"),
//                   d._unbindEvents.call(this),
//                   d._resetContentPosition.call(this),
//                   t.removeData(i),
//                   d._delete.call(null, this.mcs),
//                   f.remove(),
//                   u.replaceWith(a.contents()),
//                   t
//                     .removeClass(
//                       r +
//                         " _" +
...
//         d = {
//           _selector: function () {
//             return typeof n(this) != "object" || n(this).length < 1 ? s : this;
//           },
//           _theme: function (e) {
//             var t = [
//                 "rounded",
...
//             (e.autoDraggerLength =
//               n.inArray(e.theme, t) > -1 ? !1 : e.autoDraggerLength),
//               (e.autoExpandScrollbar =
//                 n.inArray(e.theme, r) > -1 ? !1 : e.autoExpandScrollbar),
//               (e.scrollButtons.enable =
//                 n.inArray(e.theme, i) > -1 ? !1 : e.scrollButtons.enable),
//               (e.autoHideScrollbar =
//                 n.inArray(e.theme, s) > -1 ? !0 : e.autoHideScrollbar),
//               (e.scrollbarPosition =
//                 n.inArray(e.theme, o) > -1 ? "outside" : e.scrollbarPosition);
//           },
//           _findAxis: function (e) {
//             return e === "yx" || e === "xy" || e === "auto"
//               ? "yx"
//               : e === "x" || e === "horizontal"
//               ? "x"
//               : "y";
...
//                   ? "mCSB_horizontal"
//                   : "mCSB_vertical",
//               f = s.axis === "yx" ? u[0] + u[1] : s.axis === "x" ? u[1] : u[0],
//               l =
//                 s.axis === "yx"
//                   ? "<div id='mCSB_" +
//                     t.idx +
...
//                   : "",
//               c = s.autoHideScrollbar ? " mCS-autoHide" : "",
//               h = s.axis !== "x" && t.langDir === "rtl" ? " mCS-dir-rtl" : "";
//             s.setWidth && e.css("width", s.setWidth),
//               s.setHeight && e.css("height", s.setHeight),
//               (s.setLeft =
//                 s.axis !== "y" && t.langDir === "rtl" ? "989999px" : s.setLeft),
//               e
//                 .addClass(r + " _" + i + "_" + t.idx + c + h)
//                 .wrapInner(
//                   "<div id='mCSB_" +
//                     t.idx +
...
//                 );
//             var p = n("#mCSB_" + t.idx),
//               v = n("#mCSB_" + t.idx + "_container");
//             s.axis !== "y" &&
//               !s.advanced.autoExpandHorizontalScroll &&
//               v.css("width", d._contentWidth(v.children())),
//               s.scrollbarPosition === "outside"
//                 ? (e.css("position") === "static" &&
//                     e.css("position", "relative"),
//                   e.css("overflow", "visible"),
//                   p.addClass("mCSB_outside").after(f))
//                 : (p.addClass("mCSB_inside").append(f), v.wrap(l)),
//               d._scrollButtons.call(this);
//             var m = [
//               n("#mCSB_" + t.idx + "_dragger_vertical"),
//               n("#mCSB_" + t.idx + "_dragger_horizontal"),
//             ];
...
//               t = e.data(i),
//               r = t.opt,
//               s = n(".mCSB_" + t.idx + "_scrollbar:first"),
//               o = [
...
//             if (o !== "none") {
//               var f = u
//                 ? (e.parent().height() * parseInt(o)) / 100
//                 : parseInt(o);
//               a === "border-box" &&
//                 (f -=
//                   e.innerHeight() -
...
//               ],
//               u = [
//                 r.height() / s.outerHeight(!1),
//                 r.width() / s.outerWidth(!1),
//               ],
//               a = [
//                 parseInt(o[0].css("min-height")),
//                 Math.round(u[0] * o[0].parent().height()),
//                 parseInt(o[1].css("min-width")),
//                 Math.round(u[1] * o[1].parent().width()),
//               ],
//               f = c && a[1] < a[0] ? a[0] : a[1],
//               l = c && a[3] < a[2] ? a[2] : a[3];
//             o[0]
//               .css({ height: f, "max-height": o[0].parent().height() - 10 })
...
//               ],
//               u = [
//                 s.outerHeight(!1) - r.height(),
//                 s.outerWidth(!1) - r.width(),
//               ],
//               a = [
//                 u[0] / (o[0].parent().height() - o[0].height()),
//                 u[1] / (o[1].parent().width() - o[1].width()),
//               ];
//             t.scrollRatio = { y: a[0], x: a[1] };
//           },
//           _onDragClasses: function (e, t, n) {
//             var r = n ? "mCSB_dragger_onDrag_expanded" : "",
...
//               : e[0]._draggable ||
//                 (t === "hide"
//                   ? (e.removeClass(i[0]), s.removeClass(i[1]))
//                   : (e.addClass(i[0]), s.addClass(i[1])));
//           },
...
//               r = n("#mCSB_" + t.idx),
//               s = n("#mCSB_" + t.idx + "_container"),
//               o = t.overflowed == null ? s.height() : s.outerHeight(!1),
//               u = t.overflowed == null ? s.width() : s.outerWidth(!1);
//             return [o > r.height(), u > r.width()];
//           },
...
//               ];
//             d._stop(e),
//               ((r.axis !== "x" && !t.overflowed[0]) ||
//                 (r.axis === "y" && t.overflowed[0])) &&
//                 u[0].add(o).css("top", 0);
//             if (
//               (r.axis !== "y" && !t.overflowed[1]) ||
//               (r.axis === "x" && t.overflowed[1])
//             ) {
//               var a = (dx = 0);
//               t.langDir === "rtl" &&
//                 ((a = s.width() - o.outerWidth(!1)),
...
//               r = t.opt;
//             if (!t.bindEvents) {
//               d._draggable.call(this),
//                 r.contentTouchScroll && d._contentDraggable.call(this);
//               if (r.mouseWheel.enable) {
//                 function s() {
//                   o = setTimeout(function () {
//                     n.event.special.mousewheel
//                       ? (clearTimeout(o), d._mousewheel.call(e[0]))
//                       : s();
//                   }, 1e3);
//                 }
//                 var o;
//                 s();
//               }
//               d._draggerRail.call(this),
//                 d._wrapperScroll.call(this),
//                 r.advanced.autoScrollOnFocus && d._focus.call(this),
//                 r.scrollButtons.enable && d._buttons.call(this),
//                 r.keyboard.enable && d._keyboard.call(this),
//                 (t.bindEvents = !0);
//             }
//           },
...
//               d._delete.call(null, e[0]._focusTimeout),
//               clearTimeout(r.sequential.step),
//               d._delete.call(null, r.sequential.step),
//               clearTimeout(f[0].onCompleteTimeout),
//               d._delete.call(null, f[0].onCompleteTimeout),
//               (r.bindEvents = !1));
//           },
...
//               r = t.data(i),
//               s = r.opt,
//               o = n("#mCSB_" + r.idx + "_container_wrapper"),
//               u = o.length ? o : n("#mCSB_" + r.idx + "_container"),
//               a = [
//                 n("#mCSB_" + r.idx + "_scrollbar_vertical"),
//                 n("#mCSB_" + r.idx + "_scrollbar_horizontal"),
//               ],
//               f = [a[0].find(".mCSB_dragger"), a[1].find(".mCSB_dragger")];
//             s.axis !== "x" &&
//               (r.overflowed[0] && !e
//                 ? (a[0]
//                     .add(f[0])
...
//                 : (s.alwaysShowScrollbar
//                     ? (s.alwaysShowScrollbar !== 2 &&
//                         f[0].add(a[0].children("a")).css("display", "none"),
//                       u.removeClass("mCS_y_hidden"))
//                     : (a[0].css("display", "none"), u.addClass("mCS_y_hidden")),
...
//                   : (s.alwaysShowScrollbar
//                       ? (s.alwaysShowScrollbar !== 2 &&
//                           f[1].add(a[1].children("a")).css("display", "none"),
...
//             }
//             function y(t, n, i, o) {
//               f[0].idleTimer = s.scrollInertia < 233 ? 250 : 0;
//               if (p.attr("id") === u[1])
//                 var a = "x",
//                   l = (p[0].offsetLeft - n + o) * r.scrollRatio.x;
//               else
//                 var a = "y",
//                   l = (p[0].offsetTop - t + i) * r.scrollRatio.y;
//               d._scrollTo(e, l.toString(), { dir: a, drag: !0 });
//             }
//             var e = n(this),
//               r = e.data(i),
//               s = r.opt,
...
//                     (p = n(this));
//                   var i = p.offset(),
//                     o = d._coordinates(r)[0] - i.top,
//                     u = d._coordinates(r)[1] - i.left,
//                     f = p.height() + i.top,
//                     l = p.width() + i.left;
//                   o < f && o > 0 && u < l && u > 0 && ((v = o), (m = u)),
//                     d._onDragClasses(p, "active", s.autoExpandScrollbar);
//                 }
//               )
//               .bind("touchmove." + o, function (e) {
//                 e.stopImmediatePropagation(), e.preventDefault();
//                 var t = p.offset(),
//                   n = d._coordinates(e)[0] - t.top,
//                   r = d._coordinates(e)[1] - t.left;
//                 y(v, m, n, r);
//               }),
//               n(t)
//                 .bind(
...
//                 : n[3];
//             }
//             function k(t, n, r, i, s, o) {
//               if (!t) return;
//               d._scrollTo(e, t.toString(), {
//                 dur: n,
//                 scrollEasing: r,
//                 dir: i,
//                 overwrite: s,
...
//               x = 0,
//               T,
//               N = r.axis === "yx" ? "none" : "all";
//             u
//               .bind(
//                 "touchstart." + s + " pointerdown." + s + " MSPointerDown." + s,
//                 function (e) {
//                   if (!d._pointerTouch(e) || h) return;
//                   var t = u.offset();
//                   (f = d._coordinates(e)[0] - t.top),
//                     (l = d._coordinates(e)[1] - t.left);
//                 }
//               )
//               .bind(
...
//                 function (e) {
//                   if (!d._pointerTouch(e) || h) return;
//                   e.stopImmediatePropagation(), (y = d._getTime());
//                   var n = o.offset(),
//                     i = d._coordinates(e)[0] - n.top,
//                     s = d._coordinates(e)[1] - n.left,
//                     c = "mcsLinearOut";
//                   v.push(i), m.push(s);
//                   if (t.overflowed[0])
//                     var p = a[0].parent().height() - a[0].height(),
//                       g = f - i > 0 && i - f > -(p * t.scrollRatio.y);
//                   if (t.overflowed[1])
//                     var b = a[1].parent().width() - a[1].width(),
//                       w = l - s > 0 && s - l > -(b * t.scrollRatio.x);
//                   (g || w) && e.preventDefault(),
//                     (S =
//                       r.axis === "yx"
//                         ? [f - i, l - s]
//                         : r.axis === "x"
...
//                         : [f - i, null]),
//                     (u[0].idleTimer = 250),
//                     t.overflowed[0] && k(S[0], x, c, "y", "all", !0),
//                     t.overflowed[1] && k(S[1], x, c, "x", N, !0);
//                 }
//               ),
//               o
//                 .bind(
...
//                     s,
//                   function (t) {
//                     if (!d._pointerTouch(t) || h) return;
//                     t.stopImmediatePropagation(),
//                       d._stop(e),
//                       (g = d._getTime());
//                     var n = o.offset();
//                     (c = d._coordinates(t)[0] - n.top),
//                       (p = d._coordinates(t)[1] - n.left),
//                       (v = []),
//                       (m = []);
//                   }
//                 )
...
//                   function (e) {
//                     if (!d._pointerTouch(e) || h) return;
//                     e.stopImmediatePropagation(), (b = d._getTime());
//                     var n = o.offset(),
//                       i = d._coordinates(e)[0] - n.top,
//                       s = d._coordinates(e)[1] - n.left;
//                     if (b - y > 30) return;
...
//                     var a = "mcsEaseOut",
//                       f = E < 2.5,
//                       l = f ? [v[v.length - 2], m[m.length - 2]] : [0, 0];
//                     w = f ? [i - l[0], s - l[1]] : [i - c, s - p];
//                     var x = [Math.abs(w[0]), Math.abs(w[1])];
//                     E = f ? [Math.abs(w[0] / 4), Math.abs(w[1] / 4)] : [E, E];
//                     var O = [
//                       Math.abs(u[0].offsetTop) - w[0] * C(x[0] / E[0], E[0]),
//                       Math.abs(u[0].offsetLeft) - w[1] * C(x[1] / E[1], E[1]),
//                     ];
//                     (S =
//                       r.axis === "yx"
//                         ? [O[0], O[1]]
...
//                         : [O[0], null]),
//                       (T = [
//                         x[0] * 4 + r.scrollInertia,
//                         x[1] * 4 + r.scrollInertia,
//                       ]);
//                     var _ = parseInt(r.contentTouchScroll) || 0;
//                     (S[0] = x[0] > _ ? S[0] : 0),
//                       (S[1] = x[1] > _ ? S[1] : 0),
//                       t.overflowed[0] && k(S[0], T[0], a, "y", N, !1),
//                       t.overflowed[1] && k(S[1], T[1], a, "x", N, !1);
//                   }
//                 );
//           },
...
//                   n("#mCSB_" + t.idx + "_dragger_horizontal"),
//                 ];
//               o.bind("mousewheel." + s, function (i, s) {
//                 d._stop(e);
//                 if (d._disableMousewheel(e, i.target)) return;
//                 var a =
//                   r.mouseWheel.deltaFactor !== "auto"
...
//                     ? 40
//                     : i.deltaFactor || 100;
//                 if (r.axis === "x" || r.mouseWheel.axis === "x")
//                   var f = "x",
//                     l = [
//                       Math.round(a * t.scrollRatio.x),
//                       parseInt(r.mouseWheel.scrollAmount),
//                     ],
//                     h =
//                       r.mouseWheel.scrollAmount !== "auto"
//                         ? l[1]
//                         : l[0] >= o.width()
//                         ? o.width() * 0.9
//                         : l[0],
//                     p = Math.abs(
//                       n("#mCSB_" + t.idx + "_container")[0].offsetLeft
//                     ),
//                     v = u[1][0].offsetLeft,
//                     m = u[1].parent().width() - u[1].width(),
//                     g = i.deltaX || i.deltaY || s;
//                 else
//                   var f = "y",
//                     l = [
//                       Math.round(a * t.scrollRatio.y),
//                       parseInt(r.mouseWheel.scrollAmount),
//                     ],
//                     h =
//                       r.mouseWheel.scrollAmount !== "auto"
...
//                         : l[0],
//                     p = Math.abs(
//                       n("#mCSB_" + t.idx + "_container")[0].offsetTop
//                     ),
//                     v = u[0][0].offsetTop,
...
//                 )
//                   return;
//                 r.mouseWheel.invert && (g = -g),
//                   r.mouseWheel.normalizeDelta && (g = g < 0 ? -1 : 1);
//                 if (
//                   (g > 0 && v !== 0) ||
//                   (g < 0 && v !== m) ||
...
//                 d._scrollTo(e, (p - g * h).toString(), { dir: f });
//               });
//             }
//           },
//           _disableMousewheel: function (e, t) {
//             var r = t.nodeName.toLowerCase(),
//               s = e.data(i).opt.mouseWheel.disableOver,
//               o = ["select", "textarea"];
//             return (
//               n.inArray(r, s) > -1 &&
//               !(n.inArray(r, o) > -1 && !n(t).is(":focus"))
//             );
//           },
...
//               s = n("#mCSB_" + t.idx + "_container"),
//               o = s.parent(),
//               u = n(".mCSB_" + t.idx + "_scrollbar .mCSB_draggerContainer");
//             u.bind(
//               "touchstart." + r + " pointerdown." + r + " MSPointerDown." + r,
//               function (e) {
//                 h = !0;
//               }
//             )
...
//                 if (
//                   n(r.target).hasClass("mCSB_draggerContainer") ||
//                   n(r.target).hasClass("mCSB_draggerRail")
//                 ) {
//                   d._stop(e);
//                   var i = n(this),
//                     u = i.find(".mCSB_dragger");
//                   if (i.parent(".mCSB_scrollTools_horizontal").length > 0) {
//                     if (!t.overflowed[1]) return;
//                     var a = "x",
//                       f = r.pageX > u.offset().left ? -1 : 1,
//                       l = Math.abs(s[0].offsetLeft) - f * o.width() * 0.9;
//                   } else {
//                     if (!t.overflowed[0]) return;
//                     var a = "y",
//                       f = r.pageY > u.offset().top ? -1 : 1,
//                       l = Math.abs(s[0].offsetTop) - f * o.height() * 0.9;
//                   }
//                   d._scrollTo(e, l.toString(), {
//                     dir: a,
//                     scrollEasing: "mcsEaseInOut",
//                   });
//                 }
...
//               s = r.opt,
//               o = i + "_" + r.idx,
//               u = n("#mCSB_" + r.idx + "_container"),
//               f = u.parent();
//             u.bind("focusin." + o, function (r) {
//               var i = n(t.activeElement),
//                 o = u.find(".mCustomScrollBox").length,
//                 l = 0;
//               if (!i.is(s.advanced.autoScrollOnFocus)) return;
//               d._stop(e),
//                 clearTimeout(e[0]._focusTimeout),
//                 (e[0]._focusTimer = o ? (l + 17) * o : 0),
//                 (e[0]._focusTimeout = setTimeout(function () {
//                   var t = [
//                       i.offset().top - u.offset().top,
//                       i.offset().left - u.offset().left,
//                     ],
//                     n = [u[0].offsetTop, u[0].offsetLeft],
//                     r = [
//                       n[0] + t[0] >= 0 &&
//                         n[0] + t[0] < f.height() - i.outerHeight(!1),
//                       n[1] + t[1] >= 0 &&
//                         n[0] + t[1] < f.width() - i.outerWidth(!1),
//                     ],
//                     o = s.axis === "yx" && !r[0] && !r[1] ? "none" : "all";
//                   s.axis !== "x" &&
//                     !r[0] &&
//                     d._scrollTo(e, t[0].toString(), {
//                       dir: "y",
//                       scrollEasing: "mcsEaseInOut",
//                       overwrite: o,
//                       dur: l,
...
//               t = e.data(i),
//               r = i + "_" + t.idx,
//               s = n("#mCSB_" + t.idx + "_container").parent();
//             s.bind("scroll." + r, function (e) {
...
//                 function u(t, n) {
//                   (s.scrollAmount =
//                     r.snapAmount || r.scrollButtons.scrollAmount),
//                     d._sequentialScroll.call(this, e, t, n);
//                 }
//                 i.preventDefault();
//                 if (!d._mouseBtnLeft(i)) return;
//                 var o = n(this).attr("class");
//                 s.type = r.scrollButtons.scrollType;
//                 switch (i.type) {
//                   case "mousedown":
//                   case "touchstart":
//                   case "pointerdown":
//                   case "MSPointerDown":
//                     if (s.type === "stepped") return;
//                     (h = !0), (t.tweenRunning = !1), u("on", o);
//                     break;
//                   case "mouseup":
//                   case "touchend":
//                   case "pointerup":
...
//                     break;
//                   case "click":
//                     if (s.type !== "stepped" || t.tweenRunning) return;
//                     u("on", o);
//                 }
//               }
//             );
...
//             f.attr("tabindex", "0").bind(
//               "blur." + u + " keydown." + u + " keyup." + u,
//               function (i) {
//                 function y(t, n) {
//                   (o.type = s.keyboard.scrollType),
//                     (o.scrollAmount = s.snapAmount || s.keyboard.scrollAmount);
//                   if (o.type === "stepped" && r.tweenRunning) return;
//                   d._sequentialScroll.call(this, e, t, n);
//                 }
//                 switch (i.type) {
//                   case "blur":
//                     r.tweenRunning && o.dir && y("off", null);
//                     break;
//                   case "keydown":
//                   case "keyup":
//                     var u = i.keyCode ? i.keyCode : i.which,
//                       f = "on";
//                     if (
//                       (s.axis !== "x" && (u === 38 || u === 40)) ||
//                       (s.axis !== "y" && (u === 37 || u === 39))
//                     ) {
//                       if (
//                         ((u === 38 || u === 40) && !r.overflowed[0]) ||
//                         ((u === 37 || u === 39) && !r.overflowed[1])
//                       )
//                         return;
//                       i.type === "keyup" && (f = "off"),
//                         n(t.activeElement).is(h) ||
//                           (i.preventDefault(),
//                           i.stopImmediatePropagation(),
//                           y(f, u));
//                     } else if (u === 33 || u === 34) {
//                       if (r.overflowed[0] || r.overflowed[1])
...
//                         )
//                           var m = "x",
//                             g = Math.abs(l[0].offsetLeft) - p * c.width() * 0.9;
//                         else
//                           var m = "y",
//                             g = Math.abs(l[0].offsetTop) - p * c.height() * 0.9;
//                         d._scrollTo(e, g.toString(), {
//                           dir: m,
//                           scrollEasing: "mcsEaseInOut",
//                         });
//                       }
//                     } else if (u === 35 || u === 36)
//                       if (!n(t.activeElement).is(h)) {
//                         if (r.overflowed[0] || r.overflowed[1])
//                           i.preventDefault(), i.stopImmediatePropagation();
//                         if (i.type === "keyup") {
//                           if (
...
//             );
//           },
//           _sequentialScroll: function (e, t, r) {
//             function l(t) {
//               var n = u.type !== "stepped",
//                 r = t
//                   ? n
//                     ? o.scrollInertia / 1.5
//                     : o.scrollInertia
//                   : 1e3 / 60,
//                 i = t ? (n ? 7.5 : 40) : 2.5,
//                 f = [Math.abs(a[0].offsetTop), Math.abs(a[0].offsetLeft)],
//                 c = [
...
//                 p =
//                   u.dir[0] === "x"
//                     ? f[1] + u.dir[1] * parseInt(u.scrollAmount)
//                     : f[0] + u.dir[1] * parseInt(u.scrollAmount),
//                 v = u.scrollAmount !== "auto" ? p : h,
//                 m = t ? (n ? "mcsLinearOut" : "mcsEaseInOut") : "mcsLinear",
//                 g = t ? !0 : !1;
//               t && r < 17 && (v = u.dir[0] === "x" ? f[1] : f[0]),
//                 d._scrollTo(e, v.toString(), {
//                   dir: u.dir[0],
//                   scrollEasing: m,
//                   dur: r,
//                   onComplete: g,
...
//                 ]),
//                   d._stop(e);
//                 if (d._isNumeric(r) && u.type === "stepped") return;
//                 l(f);
//                 break;
//               case "off":
//                 c(), (f || (s.tweenRunning && u.dir)) && l(!0);
//             }
//           },
//           _arr: function (e) {
//             var t = n(this).data(i).opt,
//               r = [];
//             return (
...
//                       ? [null, e[0]]
//                       : [e[0], null])
//                 : ((r[0] = e.y ? e.y : e.x || t.axis === "x" ? null : e),
//                   (r[1] = e.x ? e.x : e.y || t.axis === "y" ? null : e)),
...
//               s = r.data(i),
//               o = s.opt,
//               u = n("#mCSB_" + s.idx + "_container"),
//               a = u.parent(),
//               f = typeof e;
//             t || (t = o.axis === "x" ? "x" : "y");
//             var l = t === "x" ? u.outerWidth(!1) : u.outerHeight(!1),
//               c = t === "x" ? u.offset().left : u.offset().top,
//               h = t === "x" ? u[0].offsetLeft : u[0].offsetTop,
//               v = t === "x" ? "left" : "top";
//             switch (f) {
//               case "function":
//                 return e();
//               case "object":
//                 if (e.nodeType)
//                   var m = t === "x" ? n(e).offset().left : n(e).offset().top;
//                 else if (e.jquery) {
//                   if (!e.length) return;
//                   var m = t === "x" ? e.offset().left : e.offset().top;
//                 }
//                 return m - c;
//               case "string":
//               case "number":
//                 if (d._isNumeric.call(null, e)) return Math.abs(e);
//                 if (e.indexOf("%") !== -1)
...
//                 if (
//                   e.indexOf("px") !== -1 &&
//                   d._isNumeric.call(null, e.split("px")[0])
//                 )
//                   return Math.abs(e.split("px")[0]);
//                 if (e === "top" || e === "left") return 0;
//                 if (e === "bottom")
//                   return Math.abs(a.height() - u.outerHeight(!1));
//                 if (e === "right")
//                   return Math.abs(a.width() - u.outerWidth(!1));
//                 if (e === "first" || e === "last") {
//                   var y = u.find(":" + e),
//                     m = t === "x" ? n(y).offset().left : n(y).offset().top;
//                   return m - c;
//                 }
//                 if (n(e).length) {
//                   var m = t === "x" ? n(e).offset().left : n(e).offset().top;
//                   return m - c;
//                 }
//                 u.css(v, e), p.update.call(null, r[0]);
//                 return;
//             }
//           },
...
//               var e = 0;
//               return (
//                 s.advanced.updateOnImageLoad && (e = o.find("img").length), e
//               );
//             }
//             function w(e) {
//               function n(e, t) {
...
//               }
//               var t = new Image();
//               (t.onload = n(t, r)), (t.src = e);
//             }
//             function E() {
//               s.advanced.updateOnSelectorChange === !0 &&
//                 (s.advanced.updateOnSelectorChange = "*");
//               var e = 0,
//                 t = o.find(s.advanced.updateOnSelectorChange);
//               return (
//                 s.advanced.updateOnSelectorChange &&
//                   t.length > 0 &&
//                   t.each(function () {
...
//             }
//             function S() {
//               clearTimeout(o[0].autoUpdate), p.update.call(null, t[0]);
//             }
//             var t = n(this),
//               r = t.data(i),
//               s = r.opt,
//               o = n("#mCSB_" + r.idx + "_container");
//             if (e) {
//               clearTimeout(o[0].autoUpdate),
//                 d._delete.call(null, o[0].autoUpdate);
//               return;
//             }
//             var u = o.parent(),
//               a = [
...
//               f = function () {
//                 return [
//                   a[0].is(":visible") ? a[0].outerHeight(!0) : 0,
//                   a[1].is(":visible") ? a[1].outerWidth(!0) : 0,
//                 ];
//               },
//               l = E(),
//               c,
...
//             });
//           },
//           _scrollTo: function (e, t, r) {
//             function x(e) {
//               return s && o.callbacks[e] && typeof o.callbacks[e] == "function";
//             }
//             function T() {
//               return [
//                 o.callbacks.alwaysTriggerOffsets || m >= g[0] + b,
//                 o.callbacks.alwaysTriggerOffsets || m <= -w,
//               ];
//             }
//             function N() {
...
//                 draggerLeft: n[1],
//                 topPct: Math.round(
//                   (100 * Math.abs(t[0])) / (Math.abs(i[0]) - s[0])
//                 ),
//                 leftPct: Math.round(
//                   (100 * Math.abs(t[1])) / (Math.abs(i[1]) - s[1])
//                 ),
//                 direction: r.dir,
//               };
//             }
...
//               },
//               r = n.extend(u, r),
//               a = [r.dur, r.drag ? 0 : r.dur],
//               f = n("#mCSB_" + s.idx),
//               l = n("#mCSB_" + s.idx + "_container"),
//               c = o.callbacks.onTotalScrollOffset
//                 ? d._arr.call(e, o.callbacks.onTotalScrollOffset)
//                 : [0, 0],
//               h = o.callbacks.onTotalScrollBackOffset
//                 ? d._arr.call(e, o.callbacks.onTotalScrollBackOffset)
//                 : [0, 0];
//             (s.trigger = r.trigger),
//               o.snapAmount &&
//                 (t = d._snapAmount(t, o.snapAmount, o.snapOffset));
//             switch (r.dir) {
//               case "x":
//                 var p = n("#mCSB_" + s.idx + "_dragger_horizontal"),
//                   v = "left",
//                   m = l[0].offsetLeft,
//                   g = [
//                     f.width() - l.outerWidth(!1),
//                     p.parent().width() - p.width(),
//                   ],
//                   y = [t, t / s.scrollRatio.x],
//                   b = c[1],
//                   w = h[1],
//                   E = b > 0 ? b / s.scrollRatio.x : 0,
//                   S = w > 0 ? w / s.scrollRatio.x : 0;
//                 break;
//               case "y":
//                 var p = n("#mCSB_" + s.idx + "_dragger_vertical"),
//                   v = "top",
//                   m = l[0].offsetTop,
//                   g = [
//                     f.height() - l.outerHeight(!1),
//                     p.parent().height() - p.height(),
//                   ],
//                   y = [t, t / s.scrollRatio.y],
//                   b = c[0],
//                   w = h[0],
//                   E = b > 0 ? b / s.scrollRatio.y : 0,
//                   S = w > 0 ? w / s.scrollRatio.y : 0;
//             }
//             y[1] < 0
//               ? (y = [0, 0])
//               : y[1] >= g[1]
...
//                       !s.tweenRunning &&
//                       (x("onScrollStart") &&
//                         (N(), o.callbacks.onScrollStart.call(e[0])),
//                       (s.tweenRunning = !0),
//                       d._onDragClasses(p),
//                       (s.cbOffsets = T()));
//                   },
...
//                       r.onUpdate &&
//                       x("whileScrolling") &&
//                       (N(), o.callbacks.whileScrolling.call(e[0]));
//                   },
//                   onComplete: function () {
//                     if (r.callbacks && r.onComplete) {
//                       o.axis === "yx" && clearTimeout(l[0].onCompleteTimeout);
//                       var t = l[0].idleTimer || 0;
//                       l[0].onCompleteTimeout = setTimeout(function () {
//                         x("onScroll") && (N(), o.callbacks.onScroll.call(e[0])),
//                           x("onTotalScroll") &&
//                             y[1] >= g[1] - E &&
//                             s.cbOffsets[0] &&
//                             (N(), o.callbacks.onTotalScroll.call(e[0])),
//                           x("onTotalScrollBack") &&
//                             y[1] <= S &&
//                             s.cbOffsets[1] &&
//                             (N(), o.callbacks.onTotalScrollBack.call(e[0])),
//                           (s.tweenRunning = !1),
//                           (l[0].idleTimer = 0),
//                           d._onDragClasses(p, "hide");
//                       }, t);
//                     }
//                   },
//                 }
//               );
//           },
//           _tweenTo: function (t, n, r, i, s, o, u) {
//             function y() {
//               if (t._mcsstop) return;
//               p || a.call(),
//                 (p = d._getTime() - c),
//                 w(),
//                 p >= t._mcstime &&
//                   ((t._mcstime =
//                     p > t._mcstime ? p + h - (p - t._mcstime) : p + h - 1),
//                   t._mcstime < p + 1 && (t._mcstime = p + 1)),
//                 t._mcstime < i ? (t._mcsid = _request(y)) : l.call();
//             }
//             function w() {
//               i > 0
//                 ? ((t._mcscurrVal = x(t._mcstime, v, g, i, s)),
//                   (m[n] = Math.round(t._mcscurrVal) + "px"))
//                 : (m[n] = r + "px"),
//                 f.call();
//             }
//             function E() {
//               (h = 1e3 / 60),
//                 (t._mcstime = p + h),
//                 (_request = e.requestAnimationFrame
//                   ? e.requestAnimationFrame
//                   : function (e) {
//                       return w(), setTimeout(e, 0.01);
//                     }),
//                 (t._mcsid = _request(y));
//             }
//             function S() {
//               if (t._mcsid == null) return;
//               e.requestAnimationFrame
//                 ? e.cancelAnimationFrame(t._mcsid)
...
//                   e /= r / 2;
//                   if (e < 1) return (n / 2) * Math.pow(2, 10 * (e - 1)) + t;
//                   return e--, (n / 2) * (-Math.pow(2, -10 * e) + 2) + t;
//                 case "easeInOut":
//                 case "mcsEaseInOut":
//                   e /= r / 2;
...
//             }
//             var u = u || {},
//               a = u.onStart || function () {},
//               f = u.onUpdate || function () {},
//               l = u.onComplete || function () {},
//               c = d._getTime(),
//               h,
//               p = 0,
//               v = t.offsetTop,
//               m = t.style;
//             n === "left" && (v = t.offsetLeft);
//             var g = r - v;
//             (t._mcsstop = 0), o !== "none" && S(), E();
//           },
//           _getTime: function () {
//             return e.performance && e.performance.now
//               ? e.performance.now()
//               : e.performance && e.performance.webkitNow
...
//       (n.fn[r] = function (e) {
//         if (p[e])
//           return p[e].apply(this, Array.prototype.slice.call(arguments, 1));
//         if (typeof e == "object" || !e) return p.init.apply(this, arguments);
//         n.error("Method " + e + " does not exist");
//       }),
//         (n[r] = function (e) {
//           if (p[e])
//             return p[e].apply(this, Array.prototype.slice.call(arguments, 1));
...
//       var c = {
//           categoryCollection: new n(),
//           formCollection: new u(),
//           curentCat: null,
//           nextCat: null,
//         },
//         h = {
//           init: function () {
//             (window.ItemsCollection = new o()),
//               e.each(t, function () {
//                 var e = new r();
//                 e.set({
//                   name: this.name,
...
//                 }),
//                   c.categoryCollection.add(e);
//               });
//             var n = new i({ collection: c.categoryCollection });
//             e(".js-category-list").html(n.render().el);
//             var s = c.categoryCollection.first();
//             this.loadCategory(s, !0),
//               e(window).on("loadNewCategory", function (e, t) {
//                 e.preventDefault(),
//                   h.changeCategories.hide(
//                     c.categoryCollection.get({ cid: t }),
//                     t
//                   );
//               }),
//               this.showProductDetails(),
//               e(window).on("addToCart", function (e, t) {
//                 e.preventDefault();
//                 var n = window.ItemsCollection.get({ cid: t });
//                 h.addToCart.addToList(
//                   n.get("name"),
//                   n.get("price").current,
//                   n.get("code"),
//                   t
//                 ),
//                   c.formCollection.trigger("itemAdded");
//               }),
//               e(".shopping-cart").click(function () {
//                 h.addToCart.showForm();
//               }),
//               e(".products-form .form-close-btn").click(function () {
//                 h.addToCart.hideForm();
//               }),
//               c.formCollection.on({
//                 add: function () {
//                   h.cart.getLength(c.formCollection.length), h.cart.getTotal();
//                 },
//                 remove: function () {
//                   h.cart.getLength(c.formCollection.length), h.cart.getTotal();
//                 },
//               }),
//               e(".js-order-container").mCustomScrollbar(),
//               e(window).on("fillField", function () {
//                 e("#prCode_field").val("");
//                 var t = [];
//                 c.formCollection.forEach(function (e) {
//                   t.push({ title: e.get("name"), code: e.get("code") });
//                 }),
//                   e("#prCode_field").val(JSON.stringify(t));
//               }),
//               e(window).on("orderSent", function () {
//                 c.formCollection.reset(),
//                   h.cart.getLength(0),
//                   h.cart.getTotal(),
//                   e(".js-order-list li").wrapAll(
//                     '<div class="extra-wrapper"></div>'
//                   ),
//                   e(".extra-wrapper").velocity(
//                     { scale: "0.8", opacity: "0" },
//                     500,
//                     function () {
//                       e(".extra-wrapper").remove();
//                     }
//                   );
//               }),
//               e(".currency").html(e("body").data("currency"));
//           },
//           cart: {
//             getLength: function (t) {
//               e(".js-product-count").html(t),
//                 e("#products .products-number").hasClass("animated bounce") ||
//                   (e("#products .products-number").addClass("animated bounce"),
//                   setTimeout(function () {
//                     e("#products .products-number").removeClass(
//                       "animated bounce"
//                     );
//                   }, 1500));
//             },
...
//               var t = 0;
//               c.formCollection.forEach(function (e) {
//                 t += parseFloat(e.get("price"));
//               }),
//                 e(".js-total-price .value").html(t.toFixed(2));
//             },
//           },
//           addToCart: {
//             addToList: function (e, t, n, r) {
//               var i = new f({ name: e, price: t, parent: r, code: n });
//               c.formCollection.add(i);
//             },
//             showForm: function () {
//               var t = new l({ collection: c.formCollection });
//               e(".js-order-container .mCSB_container").append(t.render().el),
//                 e(".products-form").addClass("active");
//             },
//             hideForm: function () {
//               e(".products-form").removeClass("active"),
//                 setTimeout(function () {
//                   e(".js-order-list").remove();
//                 }, 700);
//             },
//           },
//           showProductDetails: function () {
//             e(window).on("showProductItem", function (t, n) {
//               t.preventDefault();
//               var r = window.ItemsCollection.get({ cid: n }),
//                 i = new a({ model: r });
//               e(".product-details-modal").append(i.render().el),
//                 e(".product-details-modal .images-list").waitForImages(
//                   function () {
//                     e(".product-details-modal .details-preloader").fadeOut(500);
//                   }
//                 ),
//                 e(".product-details-modal .images-list").owlCarousel({
//                   items: 1,
//                   nav: !0,
//                   navText: ["", ""],
//                   dots: !1,
//                 }),
//                 e(".product-details-modal").velocity(
//                   { translateX: ["0", "-100%"] },
//                   700,
//                   [0.7, 0, 0.3, 1],
//                   function () {
//                     e(".product-details-modal").css("overflow-y", "scroll"),
//                       e("body").css("overflow", "hidden");
//                   }
//                 ),
//                 e(".close-details", e(".product-details-modal")).click(
//                   function () {
//                     e(".product-details-modal").css("overflow", "hidden"),
...
//               c.curentCat.remove(),
//                 c.nextCat.show(),
//                 (c.curentCat = c.nextCat),
//                 h.checkNavNeed(c.curentCat),
//                 t || c.curentCat.trigger("categoryChanged"),
//                 e(".products-category-list").removeClass("active"),
//                 t &&
//                   setTimeout(function () {
//                     e(".options-list").css("opacity", "1"),
//                       e(".loader").fadeOut(10);
//                   }, 700);
//             },
//           },
//           loadCategory: function (t, n) {
//             t.set({ loaded: !0 });
//             var r = new s({ model: t }),
//               i = r.render().el;
//             e(".js-products-container").append(i);
//             var o = e(".js-products-container").find(i);
//             this.initCategoryCarousel(o),
//               n
//                 ? (c.curentCat = o)
//                 : ((c.nextCat = o),
//                   c.nextCat.waitForImages(function () {
//                     h.changeCategories.show(!0);
//                   }));
//           },
//           initCategoryCarousel: function (t) {
//             var n = {
//               items: 4,
//               nav: !0,
//               navText: ["", ""],
...
//               },
//             };
//             e(".slides", t).owlCarousel(n),
//               t.on("categoryChanged", function () {
//                 var r = e(".slides", t);
//                 r.data("owlCarousel").destroy(),
//                   r.removeClass("owl-carousel owl-loaded owl-text-select-on"),
...
//               );
//           },
//           checkNavNeed: function (t) {
//             var n = e(".owl-stage-outer", t).width(),
//               r = e(".owl-stage", t).width();
//             r <= n ? t.addClass("no-nav") : t.removeClass("no-nav");
//           },
//         };
//       h.init();
//     }
...
//       velocity: ["jquery"],
//       circleTimer: ["jquery"],
//       velocityUi: { depse: ["jquery", "velocity"] },
//       SmoothScroll: ["jquery"],
//       scroll: ["jquery"],
